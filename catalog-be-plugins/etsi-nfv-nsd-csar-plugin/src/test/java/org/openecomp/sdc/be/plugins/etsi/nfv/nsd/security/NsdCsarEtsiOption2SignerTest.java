...
import static org.openecomp.sdc.be.plugins.etsi.nfv.nsd.security.exception.NsdSignatureExceptionSupplier.certficateNotConfigured;
...
class NsdCsarEtsiOption2SignerTest {
    ...
    void signNsdNoCertificateTest() {
        ...
        final NsdSignatureException actualException = assertThrows(NsdSignatureException.class,
            () -> nsdCsarEtsiOption2Signer.signArtifacts(nsdCsar));
        assertThat(actualException.getMessage(), is(certficateNotConfigured().getMessage()));
    }
