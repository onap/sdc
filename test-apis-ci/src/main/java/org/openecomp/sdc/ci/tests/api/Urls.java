...
public interface Urls {
	...
	final String GET_SERVICE_LIST = SDC_HTTP_METHOD + "://%s:%s/sdc2/rest/v1/catalog/services";

	// Get service versions:
	// http://172.20.43.124:8080/sdc2/rest/v1/catalog/services/MyService
	final String GET_SERVICE_VERSIONS = SDC_HTTP_METHOD + "://%s:%s/sdc2/rest/v1/catalog/services/%s";
	...
	final String GET_SERVICE_ARTIFACT_PAYLOAD = SDC_HTTP_METHOD + "://%s:%s/sdc2/rest/v1/catalog/resources/%s/%s/artifacts/%s";
