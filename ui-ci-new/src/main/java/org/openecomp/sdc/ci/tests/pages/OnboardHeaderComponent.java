...
public class OnboardHeaderComponent extends AbstractPageObject {
    ...
    public void isLoaded() {
        ...
        getWait()
            .until(ExpectedConditions.elementToBeClickable(By.xpath(WORKSPACE_TAB_DIV.getXpath())));
        getWait()
            .until(ExpectedConditions.elementToBeClickable(By.xpath(ONBOARD_TAB_DIV.getXpath())));
    }
