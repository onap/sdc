...
public class DownloadManager {
     ...
     * @throws Exception
     */
    public static void downloadCsarByNameFromVSPRepository(String vspName, Boolean isDelete) {
    ...
    public static void downloadCsarByNameFromVSPRepository(final String vspName) {
