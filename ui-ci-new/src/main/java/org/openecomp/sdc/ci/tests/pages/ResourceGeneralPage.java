...
public final class ResourceGeneralPage {

    private static final int SLEEP_DURATION = 500;

    private ResourceGeneralPage() {
    ...
    public static String getVersionUI() {
        return GeneralUIUtils
            .getSelectedElementFromDropDown(DataTestIdEnum.GeneralElementsEnum.VERSION_HEADER.getValue()).getText()
            .replace("V", "");
    }
}
