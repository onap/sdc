...
public abstract class SetupCDTest extends DriverFactory {
    ...
    private static void setErrorConfigurationFile() {
        if (!System.getProperty("os.name").contains("Windows")) {
            ...
            errorConfigurationFilename = errorConfigurationFilename.substring(errorConfigurationFilename.lastIndexOf("/") + 1);
    ...
    public void setBrowserBeforeTest(java.lang.reflect.Method method, ITestContext context) {
        ...
        if (emptyDataProvider && !className.contains("ToscaValidationTest")) {
            LOGGER.debug("ExtentReport instance started from BeforeMethod...");
    ...
    public void quitAfterTest(final ITestResult result, final ITestContext context) {
        try {
...
//			write result to csv file
    ...
    private void addResultToCSV(ITestResult result) {
...
//            MobProxy.getPoxyServer().stop();
    ...
    private void loginToSystem(UserRoleEnum role) {
    ...
    private void goToHomePage(UserRoleEnum role) {
