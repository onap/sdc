...
public class ForwardPathMigration implements Migration {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ForwardPathMigration.class);
    ...
    public MigrationResult migrate() {
        logger.info("start change resource lifecycle states migration");
        ...
        return status == StorageOperationStatus.OK ? MigrationResult.success()
            : MigrationResult.error("failed to create connection between instances and origins. Error : " + status);
