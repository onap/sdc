 ...
 * <br>2. Provide keywords to search using {@link #filter(String)} or {@link #filter(List)}
...
public class YamlParser implements AutoCloseable {
    ...
    private List<SimpleEntry<String, ? extends Collection<Object>>> findInJson(List<String> keys,
