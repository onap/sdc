...
public enum PropertyType {
  ...
  private static final List<String> simplePropertyTypes =
      Collections.unmodifiableList(initializeSimplePropertyTypes());
  ...
  private static List<String> initializeSimplePropertyTypes() {
    List<String> simplePropertyTypes = new ArrayList<>();
  ...
  public static List<String> getSimplePropertyTypes() {
    if (simplePropertyTypes == null) {
      initializeSimplePropertyTypes();
    }
    return simplePropertyTypes;
  }
