    ...
    render() {
        ...
        return (
            <div className="validation-setup-checkbox-tree-section">
                <GridSection title="Certifications Query">
                    <GridItem colSpan={2}>
                        <div className="validation-view-title">
                            {i18n('Available Certifications Query')}
                        </div>
...
class ComplianceTests extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="validation-setup-checkbox-tree-section">
                <GridSection title="Compliance Checks">
                    <GridItem colSpan={2}>
                        <div className="validation-view-title">
                            {i18n('Available Compliance Checks')}
                        </div>
                        <div className="validation-setup-available-tests-section">
                            ...
                            {complianceNodes.length === 0 && (
                                <div>No Compliance Checks are Available</div>
                            )}
                        </div>
                    </GridItem>
                    <GridItem colSpan={2}>
                        {complianceNodes.length > 0 && (
                            <div>
                                <div className="validation-view-title">
                                    {i18n('Selected Compliance Checks')}
                                </div>
                                <div>
                                    <select
                                        className="validation-setup-selected-tests"
