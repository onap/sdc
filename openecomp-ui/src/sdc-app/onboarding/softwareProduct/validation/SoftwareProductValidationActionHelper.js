 ...
 */
//import { actionTypes } from './SoftwareProductValidationMonitorConstants.js';
...
function postVSPCertificationChecks(tests) {
    ...
    return RestAPIUtil.post(`${restPrefix}/v1.0/externaltesting/run`, {
...
function fetchVspChecks() {
    const restPrefix = Configuration.get('restPrefix');
    return RestAPIUtil.get(`${restPrefix}/v1.0/externaltesting`);
}

const SoftwareProductValidationActionHelper = {
    navigateToSoftwareProductValidationMonitor(
        dispatch,
        ...
        postVSPCertificationChecks(tests)
            .then(response => {
                ...
                ScreensHelper.loadScreen(dispatch, {
                    screen: enums.SCREEN.SOFTWARE_PRODUCT_VALIDATION_MONITOR,
