...
export const mapStateToProps = (response) => {
	...
	return {
		//vnfItems: response.softwareProduct.VNFMarketPlaceImport ? response.softwareProduct.VNFMarketPlaceImport.vnfItems : []
		vnfItems: vnfItems
	};
};
...
export const mapActionsToProps = (dispatch) => {
	return {
		...
		onSubmit: (csarId) => {
			console.log('on click of Submit Button, csar id is : ' + csarId);
		}
	};
};
