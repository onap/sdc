...
class VendorSelector extends React.Component {
	...
	constructor(props){
		super(props);
		this.state = {
			selectedValue: props.finalizedLicenseModelList[0].id
		};
	}
	submit() {
		...
		return (
			<div className='vsp-details-vendor-select'>
				<Form 
					...
					hasButtons={true}>
						<div className='vendor-selector-modal-title'>The VLM `{vendorName}` assigned to this VSP is archived.</div>
						<div className='vendor-selector-modal-additional-text'>If you select a different VLM you will not be able to reselect the archived VLM.</div>
						<Input
