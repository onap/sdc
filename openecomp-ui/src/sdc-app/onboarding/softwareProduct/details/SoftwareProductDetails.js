...
export const mapStateToProps = ({
	...
	const isVendorDepricated = archivedLicenseModelList.find(item => item.id === currentSoftwareProduct.vendorId);
	return {
		...
		qGenericFieldInfo,
		dataMap,
		isVendorDepricated: !!isVendorDepricated
	};
...
export const mapActionsToProps = (dispatch, {version}) => {
	return {
		...
		onDeprecatedVendorRemove: ({onVendorParamChanged, finalizedLicenseModelList, vendorName}) => dispatch({
