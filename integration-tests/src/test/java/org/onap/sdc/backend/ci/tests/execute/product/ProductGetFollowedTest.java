...
public class ProductGetFollowedTest extends ProductBaseTest {
	...
	private void createProducts() throws Exception {
		...
		productDetails200 = new ElementFactory().getDefaultProduct("CiProd200", defaultCategories);
		productDetails400 = new ElementFactory().getDefaultProduct("CiProd400", defaultCategories);
