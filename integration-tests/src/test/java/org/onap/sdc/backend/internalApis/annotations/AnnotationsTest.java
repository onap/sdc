...
public class AnnotationsTest extends ComponentBaseTest {
    ...
    public void whenExportingToscaOfTopologyTemplate_annotationTypeYamlExist_sourceAnnotationExist() throws Exception {
        ...
        ResourceReqDetails resourceDetails = new ElementFactory().getDefaultResourceByType("exportToscaAnnotationsYml", NormativeTypesEnum.ROOT, ResourceCategoryEnum.GENERIC_INFRASTRUCTURE, sdncModifierDetails.getUserId(), ResourceTypeEnum.VF.toString());
    ...
    private List<ComponentInstanceInput> declareProperties(Service service, ComponentInstance instance, String ... propertiesToDeclareNames) throws Exception {
        ...
        RestResponse restResponse = PropertyRestUtils.declareProporties(service, propertiesToDeclare, new ElementFactory().getDefaultUser(UserRoleEnum.DESIGNER));
