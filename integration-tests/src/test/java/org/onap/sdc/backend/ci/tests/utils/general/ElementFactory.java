...
public final class ElementFactory {
    ...
    private final String CI_SERVICE = "ciService";
    private final String CI_RES = "ciRes";
    private final String CI_PRODUCT = "CiProduct";
    private final String DEFAULT_ARTIFACT_LABEL = "artifact1";
    private final String RESOURCE_INSTANCE_POS_X = "20";
    private final String RESOURCE_INSTANCE_POS_Y = "20";
    private final String RESOURCE_INSTANCE_DESCRIPTION = "description";
    ...
    public ResourceReqDetails getDefaultResource() {
        return getDefaultResource(CI_RES, NormativeTypesEnum.ROOT, ResourceCategoryEnum.GENERIC_INFRASTRUCTURE, "jh0003");
    }

    public ResourceReqDetails getDefaultResource(ResourceCategoryEnum category) {
        return getDefaultResource(CI_RES, NormativeTypesEnum.ROOT, category, "jh0003");
    }

    public ResourceReqDetails getDefaultResource(String contactId) {
        return getDefaultResource(CI_RES, NormativeTypesEnum.ROOT, ResourceCategoryEnum.GENERIC_INFRASTRUCTURE, contactId);
    }

    public ResourceReqDetails getDefaultResource(User modifier) {
        return getDefaultResource(CI_RES, NormativeTypesEnum.ROOT, ResourceCategoryEnum.GENERIC_INFRASTRUCTURE, modifier.getUserId());
    }

    public ResourceReqDetails getDefaultResource(NormativeTypesEnum derivedFrom, ResourceCategoryEnum category) {
        return getDefaultResource(CI_RES, derivedFrom, category, "jh0003");
    }

    public ResourceReqDetails getDefaultResource(NormativeTypesEnum derivedFrom) {
        return getDefaultResource(CI_RES, derivedFrom, ResourceCategoryEnum.GENERIC_INFRASTRUCTURE, "jh0003");
    }

    public ResourceReqDetails getDefaultResource(String resourceName, NormativeTypesEnum derivedFrom) {
        return getDefaultResource(resourceName, derivedFrom, ResourceCategoryEnum.GENERIC_INFRASTRUCTURE, "jh0003");
    }

    public ResourceReqDetails getDefaultResource(NormativeTypesEnum derivedFrom, String contactId) {
        return getDefaultResource(CI_RES, derivedFrom, ResourceCategoryEnum.GENERIC_INFRASTRUCTURE, contactId);
    }

    // New
    public ResourceReqDetails getDefaultResourceByType(ResourceTypeEnum ResourceType, String resourceName, ResourceCategoryEnum resourceCategory, String vendorName, String vendorModelNumber) {
    ...
    public ResourceReqDetails getDefaultResourceByType(ResourceTypeEnum ResourceType, String resourceName) {
    ...
    public ResourceReqDetails getDefaultResourceByType(ResourceTypeEnum ResourceType, User user) {
    ...
    public ResourceReqDetails getDefaultResourceByTypeNormTypeAndCatregory(ResourceTypeEnum resourceType, NormativeTypesEnum normativeTypes, ResourceCategoryEnum resourceCategory, User user) {
        return getDefaultResourceByType(CI_RES, normativeTypes, resourceCategory, user.getUserId(), resourceType.toString());
    }

    public PropertyReqDetails getDefaultMapProperty(PropertyTypeEnum innerType) {
        return getPropertyDetails(innerType);
    }

    public PropertyReqDetails getDefaultMapProperty() {
        return getPropertyDetails(PropertyTypeEnum.STRING_MAP);
    }

    public ResourceReqDetails getDefaultResource(String resourceName, NormativeTypesEnum derived, ResourceCategoryEnum category, String contactId) {
    ...
    public ResourceReqDetails getDefaultResourceByTypeNormTypeAndCatregory(ResourceTypeEnum resourceType, Resource normativeTypes, ResourceCategoryEnum resourceCategory, User user) {
        return getDefaultResource(CI_RES + resourceType, normativeTypes, resourceCategory, user.getUserId());
    }

    public ResourceReqDetails getDefaultResource(String resourceName, Resource derived, ResourceCategoryEnum category, String contactId) {
        resourceName = addRandomSuffixToName(resourceName);
        String description = "Represents a generic software component that can be managed and run by a Compute Node Type.";
        ArrayList<String> resourceTags = new ArrayList<>();
        resourceTags.add(resourceName);
    ...
    public String addRandomSuffixToName(final String name) {
        return name + generateUUIDforSufix();
    }

    public ResourceReqDetails getDefaultResourceByType(String resourceName, NormativeTypesEnum derived, ResourceCategoryEnum category, String contactId, ResourceTypeEnum resourceType) {
        return getDefaultResourceByType(resourceName, derived, category, contactId, resourceType.toString());
    }

    // New
    public ResourceReqDetails getDefaultResourceByType(String resourceName, NormativeTypesEnum derived, ResourceCategoryEnum category, String contactId, String resourceType) {
    ...
    public ResourceReqDetails getDefaultResourceByType(String resourceName, NormativeTypesEnum derived, ResourceCategoryEnum category, String contactId, String resourceType, String vendorName, String vendorModelNumber) {
        resourceName = (resourceName + resourceType + generateUUIDforSufix());
    ...
    public ResourceReqDetails getRandomCategoryResource() {
        ResourceReqDetails resourceDetails = getDefaultResource(ResourceCategoryEnum.getRandomElement());
        return resourceDetails;
    }

    public ResourceExternalReqDetails getDefaultResourceByType(String resourceName, ResourceCategoryEnum category, String contactId, String resourceType) {
        resourceName = (resourceName + resourceType + generateUUIDforSufix());
        String description = "Represents a generic software component that can be managed and run by a Compute Node Type.";
        ArrayList<String> resourceTags = new ArrayList<>();
        resourceTags.add(resourceName);
    ...
    // New
    public ImportReqDetails getDefaultImportResourceByType(String resourceName, NormativeTypesEnum derived, ResourceCategoryEnum category, String contactId, String resourceType) {
        resourceName = (resourceName + resourceType + generateUUIDforSufix());
        String description = "Represents a generic software component that can be managed and run by a Compute Node Type.";
        ArrayList<String> resourceTags = new ArrayList<>();
        resourceTags.add(resourceName);
    ...
    public ImportReqDetails getDefaultImportResource(ResourceReqDetails resourceReqDetails) {
    ...
    public ImportReqDetails getDefaultImportResource() {
    ...
    public ImportReqDetails getDefaultImportResource(String name) {
    ...
    public ServiceReqDetails getDefaultService(User user) {
    ...
    public ServiceReqDetails getDefaultService(ServiceCategoriesEnum category, User user) {
        return getDefaultService(CI_SERVICE, category, user.getUserId(), ServiceInstantiationType.A_LA_CARTE.getValue());
    }

    public ServiceReqDetails getServiceByCategory(ServiceCategoriesEnum category) {
        return getDefaultService(CI_SERVICE, category, "al1976", ServiceInstantiationType.A_LA_CARTE.getValue());
    }

    public ServiceReqDetails getDefaultService(String serviceName, ServiceCategoriesEnum category, String contactId, String instantiationType) {
        ...
        return new ServiceReqDetails(serviceName, category.getValue(), tags, description, contactId, icon, instantiationType);
    }

    public ServiceReqDetails getRandomCategoryService() {
        return getServiceByCategory(ServiceCategoriesEnum.getRandomElement());
    }

    // ***** PROPERTY ***

    public PropertyReqDetails getDefaultProperty() {
        return getDefaultProperty("disk_size");
    }

    public PropertyReqDetails getDefaultProperty(String propertyName) {
    ...
    public PropertyReqDetails getDefaultIntegerProperty() {
        return getPropertyDetails(PropertyTypeEnum.INTEGER);
    }

    public PropertyReqDetails getDefaultStringProperty() {
        return getPropertyDetails(PropertyTypeEnum.STRING);
    }

    public PropertyReqDetails getDefaultBooleanProperty() {
        return getPropertyDetails(PropertyTypeEnum.BOOLEAN);
    }

    public PropertyReqDetails getDefaultListProperty() {
        return getPropertyDetails(PropertyTypeEnum.STRING_LIST);
    }

    public PropertyReqDetails getDefaultListProperty(PropertyTypeEnum innerType) {
        return getPropertyDetails(innerType);
    }

    public PropertyReqDetails getPropertyDetails(PropertyTypeEnum propType) {
    ...
    // ***** RESOURCE INSTANCE ***
    public ComponentInstanceReqDetails getDefaultComponentInstance() {
        return getDefaultComponentInstance("resourceInstanceName");
    }

    public ComponentInstanceReqDetails getDefaultComponentInstance(String name) {
        String resourceUid = "resourceId";

        return new ComponentInstanceReqDetails(resourceUid, RESOURCE_INSTANCE_DESCRIPTION, RESOURCE_INSTANCE_POS_X, RESOURCE_INSTANCE_POS_Y, name, null);

    }

    public ComponentInstanceReqDetails getDefaultComponentInstance(String name, ComponentReqDetails componentReqDetails) {
    ...
    public ComponentInstanceReqDetails getDefaultComponentInstance(String serviceUniqueId, String originType) {
    ...
    public ComponentInstanceReqDetails getComponentResourceInstance(ComponentReqDetails compInstOriginDetails) {
        ...
        return new ComponentInstanceReqDetails(resourceUid, RESOURCE_INSTANCE_DESCRIPTION, RESOURCE_INSTANCE_POS_X, RESOURCE_INSTANCE_POS_Y, compInstName, null);

    }

    public ComponentInstanceReqDetails getComponentInstance(Component compInstOriginDetails) {
        ...
        return new ComponentInstanceReqDetails(compInsUid, RESOURCE_INSTANCE_DESCRIPTION, RESOURCE_INSTANCE_POS_X, RESOURCE_INSTANCE_POS_Y, compInstName, compInstOriginDetails.getComponentType() == ComponentTypeEnum.SERVICE ? OriginTypeEnum.ServiceProxy.name() : null);

    }

    //********ServiceFilter**********
    public ServiceFilterDetails getDefaultEqualOperatorFilter(String propertyName, String valueString) {
        return new ServiceFilterDetails(propertyName, "equal", "static", "static", valueString);
    }

    public ServiceFilterDetails getDefaultFilter(String propertyName, String valueString,
                                                 String operator) {
        return new ServiceFilterDetails(propertyName, operator, "static", "static", valueString);
    }

    // ******* USER **********************
    public User getDefaultUser(UserRoleEnum userRole) {
    ...
    public User getDefaultMechUser() {
    ...
    public ConsumerDataDefinition getDefaultConsumerDetails() {
    ...
    // *** ARTIFACT ***
    public ArtifactReqDetails getDefaultArtifact() throws IOException, Exception {
        return getDefaultArtifact(DEFAULT_ARTIFACT_LABEL);
    }

    public ArtifactReqDetails getDefaultArtifact(String artifactLabel) throws IOException, Exception {
    ...
    public ArtifactReqDetails getDefaultArtifact(String artifactLabel, String artifactType) throws IOException, Exception {
    ...
    public ArtifactReqDetails getServiceApiArtifactDetails(String artifactLabel) throws IOException, Exception {
    ...
    public ArtifactReqDetails getDefaultDeploymentArtifactForType(String artifactType) throws IOException, Exception {
        return getArtifactByType(DEFAULT_ARTIFACT_LABEL, artifactType, true, false);
    }

    public ArtifactReqDetails getArtifactByType(ArtifactTypeEnum artifactLabel, ArtifactTypeEnum artifactType, Boolean deploymentTrue) throws IOException, Exception {
        return getArtifactByType(DEFAULT_ARTIFACT_LABEL, artifactType.toString(), deploymentTrue, false);

    }

    public ArtifactReqDetails getArtifactByType(String artifactLabel, String artifactType, Boolean deploymentTrue, Boolean updatedPayload) throws IOException, Exception {
        String artifactName;
    ...
    private String getDcaeArtifactName(ArtifactTypeEnum artifactTypeEnum, String artifactType) {
    ...
    // ---------------------Audit message------------------
    public ExpectedResourceAuditJavaObject getDefaultImportResourceAuditMsgSuccess() {
        ...
        expectedResourceAuditJavaObject.setModifierName(getDefaultUser(UserRoleEnum.DESIGNER).getFullName());
        expectedResourceAuditJavaObject.setModifierUid(getDefaultUser(UserRoleEnum.DESIGNER).getUserId());
    ...
    public ExpectedResourceAuditJavaObject getDefaultImportResourceAuditMsgFailure(ErrorInfo errorInfo, List<String> variables) {
    ...
    public ExpectedResourceAuditJavaObject getDefaultCertificationRequestAuditMsgSuccess() {
    ...
    public ExpectedResourceAuditJavaObject getDefaultCertificationRequestAuditMsgFailure(ErrorInfo errorInfo, List<String> variables) {
    ...
    public ExpectedExternalAudit getDefaultExternalAuditObject(AssetTypeEnum assetType, AuditingActionEnum action, String query) {
    ...
    public ExpectedExternalAudit getDefaultAssetListAudit(AssetTypeEnum assetType, AuditingActionEnum auditAction) {
    ...
    public ExpectedExternalAudit getDefaultFilteredAssetListAudit(AssetTypeEnum assetType, String query) {
    ...
    public ExpectedExternalAudit getDefaultExternalArtifactAuditSuccess(AssetTypeEnum assetType, AuditingActionEnum action, ArtifactDefinition artifactDefinition, String componentUUID) {
    ...
    public ExpectedExternalAudit getDefaultExternalArtifactAuditSuccess(AssetTypeEnum assetType, AuditingActionEnum action, ArtifactDefinition artifactDefinition, Component component) {
    ...
    public ExpectedResourceAuditJavaObject getDefaultCreateResourceExternalAPI(String resourceName) {
    ...
    public ExpectedResourceAuditJavaObject getDefaultChangeAssetLifeCycleExternalAPI(Component resourceAssetStructure, User defaultUser, LifeCycleStatesEnum lifecycleStateEnum, AssetTypeEnum assetTypeEnum) {
...
//		expectedResourceAuditJavaObject.setINVARIANT_UUID(resourceAssetStructure.getInvariantUUID());
    ...
    public ExpectedResourceAuditJavaObject getDefaultInvalidChangeAssetLifeCycleExternalAPI(String assetUUID, User defaultUser, LifeCycleStatesEnum lifecycleStateEnum, AssetTypeEnum assetTypeEnum) {
    ...
    public ExpectedExternalAudit getDefaultExternalArtifactAuditSuccess(AssetTypeEnum assetType, AuditingActionEnum action, ArtifactDefinition artifactDefinition, String componentUUID, String resourceInstanceName) {
    ...
    public ExpectedExternalAudit getDefaultExternalArtifactAuditFailure(AssetTypeEnum assetType, AuditingActionEnum action, ArtifactDefinition artifactDefinition, String componentUUID, ErrorInfo errorInfo, List<String> variables) {
    ...
    public ExpectedExternalAudit getFilteredAssetListAuditCategoryNotFound(AssetTypeEnum assetType, String query, String category) {
    ...
    public ExpectedExternalAudit getDefaultAssetMetadataAudit(AssetTypeEnum assetType, Component component) {
    ...
    public ExpectedExternalAudit getDefaultAssetMetadataAuditFailure(AssetTypeEnum assetType, String serviceUuid, String resourceType) {
    ...
    public CategoryDefinition getDefaultCategory() {
    ...
    public SubCategoryDefinition getDefaultSubCategory() {
    ...
    public GroupingDefinition getDefaultGroup() {
    ...
    public ProductReqDetails getDefaultProduct() {
        return createDefaultProductReqDetails(CI_PRODUCT, null);
    }

    public ProductReqDetails getDefaultProduct(String name) {
        return createDefaultProductReqDetails(name, null);
    }

    public ProductReqDetails getDefaultProduct(CategoryDefinition category) {
        List<CategoryDefinition> categories = new ArrayList<>();
        categories.add(category);
        return createDefaultProductReqDetails(CI_PRODUCT, categories);
    }

    public ProductReqDetails getDefaultProduct(String name, CategoryDefinition category) {
        List<CategoryDefinition> categories = new ArrayList<>();
        categories.add(category);
        return createDefaultProductReqDetails(name, categories);
    }

    public ProductReqDetails getDefaultProduct(List<CategoryDefinition> categories) {
        return createDefaultProductReqDetails(CI_PRODUCT, categories);
    }

    public ProductReqDetails getDefaultProduct(String name, List<CategoryDefinition> categories) {
        return createDefaultProductReqDetails(name, categories);
    }

    private ProductReqDetails createDefaultProductReqDetails(String productName, List<CategoryDefinition> categories) {
        ...
        // contacts.add(new ElementFactory().getDefaultUser(UserRoleEnum.PRODUCT_STRATEGIST1).getUserId());
        // contacts.add(new ElementFactory().getDefaultUser(UserRoleEnum.PRODUCT_STRATEGIST2).getUserId());
        contacts.add(getDefaultUser(UserRoleEnum.PRODUCT_MANAGER1).getUserId());
        // contacts.add(new ElementFactory().getDefaultUser(UserRoleEnum.PRODUCT_MANAGER2).getUserId());
    ...
    public RequirementCapabilityRelDef getReqCapRelation(String fromCompInstId, String toCompInstId, String reqOwnerId, String capOwnerId, String capType, String reqCapName, List<CapabilityDefinition> capList,
    ...
    public String generateUUIDforSufix() {
        final String uniqueSuffix = UUID.randomUUID().toString();
        return uniqueSuffix.split("-")[4];
    }

    private String normalizeArtifactLabel(String label) {
