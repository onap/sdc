...
public class PlaceHolderValidations extends ComponentBaseTest {
	...
	protected User sdncDesignerDetails1 = new ElementFactory().getDefaultUser(UserRoleEnum.DESIGNER);
	protected User sdncDesignerDetails2 = new ElementFactory().getDefaultUser(UserRoleEnum.DESIGNER2);
	...
	public void validateDeploymentPlaceHoldersByConfig() throws IOException {
		RestResponse resourceGetResponse = new ResourceRestUtils().getResource(resourceDetails1, sdncDesignerDetails1);
	...
	/*private void validateToscaArtifactsBeforeAndAfterSFT(ResourceReqDetails resourceDetails)
		...
		RestResponse componentResponse = new ResourceRestUtils().getResource(resourceDetails, sdncDesignerDetails1);
	...
	public void validateToscaPlaceHoldersByConfig() throws IOException, Exception {
		...
		RestResponse componentGetResponse = new ResourceRestUtils().getResource(resourceDetails1, sdncDesignerDetails1);
		components.add(ResponseParser.convertResourceResponseToJavaObject(componentGetResponse.getResponse()));

		componentGetResponse = new ResourceRestUtils().getResource(resourceCP, sdncDesignerDetails1);
		components.add(ResponseParser.convertResourceResponseToJavaObject(componentGetResponse.getResponse()));

		componentGetResponse = new ResourceRestUtils().getResource(resourceVF, sdncDesignerDetails1);
		components.add(ResponseParser.convertResourceResponseToJavaObject(componentGetResponse.getResponse()));

		componentGetResponse = new ResourceRestUtils().getResource(resourceVL, sdncDesignerDetails1);
		components.add(ResponseParser.convertResourceResponseToJavaObject(componentGetResponse.getResponse()));
		...
		componentGetResponse = new ServiceRestUtils().getService(service.getUniqueId(),
	...
	public void addDepResArtEachType() throws Exception {
		...
		RestResponse response = new ResourceRestUtils().getResource(resourceDetails1.getUniqueId());
	...
	public void addAndDeleteDepResArtEachType() throws Exception {
		...
		response = new ResourceRestUtils().getResource(resourceDetails1.getUniqueId());
		resource = ResponseParser.convertResourceResponseToJavaObject(response.getResponse());
	...
	public void addRemoveAddAgainArtifact() throws Exception {
		...
		RestResponse getResourceResp = new ResourceRestUtils().getResource(resourceDetails1, sdncDesignerDetails1);
	...
	private ArtifactReqDetails getUpdateArtifactDetails(String artType) throws IOException, Exception {
		...
		ArtifactReqDetails updateArtifactReqDetails = new ElementFactory().getDefaultDeploymentArtifactForType(artType);
