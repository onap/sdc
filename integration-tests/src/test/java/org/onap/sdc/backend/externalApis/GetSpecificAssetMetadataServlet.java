...
//	}
	...
	public void getResourceAssetMetadataWithResourceInstancesSuccess() throws Exception {
		...
		resourceVF = ResponseParser.parseToObjectUsingMapper(new ResourceRestUtils().getResource(resourceVF.getUniqueId()).getResponse(), Resource.class);
	...
	*//*	// Validate audit message
	...
	public void getServiceAssetMetadataWithResourceInstancesSuccess() throws Exception {
		...
		service = ResponseParser.parseToObjectUsingMapper(new ServiceRestUtils().getService(service.getUniqueId(), new ElementFactory().getDefaultUser(UserRoleEnum.DESIGNER)).getResponse(),Service.class);
	...
	/*private void validateAudit(Component component, AssetTypeEnum assetType) throws Exception {
		ExpectedExternalAudit expectedAssetListAudit = new ElementFactory().getDefaultAssetMetadataAudit(assetType, component);
