...
public class UpdateResourceMetadataTest extends ComponentBaseTest {
    ...
    public void setup() throws Exception {
        sdncModifierDetails = new ElementFactory().getDefaultUser(UserRoleEnum.DESIGNER);
    ...
    public void UpdateResource_NoTagsEqualToResourceName() throws Exception {
        ...
        User adminModifierDetails = new ElementFactory().getDefaultUser(UserRoleEnum.ADMIN);
        String resourceBaseVersion = "0.1";
    ...
    public void UpdateResourceName_negativeFlow() throws Exception {
        ...
        User sdncAdminModifierDetails = new ElementFactory().getDefaultUser(UserRoleEnum.ADMIN);
