...
/*	// US824692 - Story [BE]: External API for asset lifecycle - submit for test / start testing
	...
	public void theFlow() throws Exception {
		...
		restResponse = new ResourceRestUtils().getResourceListFilterByCriteria(ElementFactory.getDefaultUser(UserRoleEnum.DESIGNER), AssetTypeEnum.RESOURCES.getValue(), SearchCriteriaEnum.RESOURCE_TYPE.getValue(), ResourceTypeEnum.VFCMT.toString());
