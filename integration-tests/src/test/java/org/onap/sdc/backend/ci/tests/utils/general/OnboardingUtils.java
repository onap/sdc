...
public class OnboardingUtils {
     ...
     */
    public static final List<String> excludeXnfList =
//		new ArrayList<>();
            Arrays.asList(
...
//		Error: TOSCA yaml file %1 cannot be modeled to VF as it does not contain \u0027topology_template
     ...
     */
    protected static final List<String> excludeXnfListForToscaParser =
            Arrays.asList(
	...
	public  String getVspValidationConfiguration() throws Exception {
    ...
    public  String putVspValidationConfiguration(boolean value) throws Exception {
        Config config = Utils.getConfig();
        String url = String.format(Urls.VSP_VALIDATION_CONFIGURATION, config.getOnboardingBeHost(), config.getOnboardingBePort());
        Map<String, String> headersMap = prepareHeadersMap("cs0008");
    ...
    protected  Map<String, String> prepareHeadersMap(String userId) {
    ...
    /**
     * @return The method returns XNF names list from Files directory under sdc repository
     */
    public  List<String> getXnfNamesFileList(PackageTypeEnum packageTypeEnum) {
    ...
    /**
     * @return The method returns names list of invalid XNF packages from Files directory under sdc repository
     */
    public  List<String> getInvalidXnfNamesFileList(PackageTypeEnum packageTypeEnum) {
    ...
    /**
     * @return The method returns names list of XNF packages with warnings from Files directory under sdc repository
     */
    public  List<String> getXnfNamesWithWarningsFileList(PackageTypeEnum packageTypeEnum) {
     ...
     */
    public  List<String> getVfcFilenameList() {
    ...
    /**
     * @return The method returns VNF names list from Files directory under sdc-vnfs repository excluding zip files that known as failed in tosca parser
     */
    public  List<String> getVnfNamesFileListExcludeToscaParserFailure() {
    ...
    public  Object[][] filterObjectArrWithExcludedVnfs(Object[][] objectArr) {
