...
public class ComplexResourceBaseTest extends ComponentBaseTest {
	...
	public void initializeMembers() throws IOException, Exception {
		...
		resourceDetailsVFC = new ElementFactory().getDefaultResourceByType(ResourceTypeEnum.VFC, "resourceVFC");
		resourceDetailsVF = new ElementFactory().getDefaultResourceByType(ResourceTypeEnum.VF, "resourceVF3");
		resourceDetailsVL = new ElementFactory().getDefaultResourceByType(ResourceTypeEnum.VL, "resourceVL");
		resourceDetailsCP = new ElementFactory().getDefaultResourceByType(ResourceTypeEnum.CP, "resourceCP");
