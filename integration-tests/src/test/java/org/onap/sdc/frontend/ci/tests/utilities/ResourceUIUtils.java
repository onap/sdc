...
public final class ResourceUIUtils {
    ...
    public static void selectRandomResourceIcon() throws Exception {
        ...
        wait.until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@data-tests-id, 'iconBox')]")).apply(webDriver));
    ...
    public static void getWebElementByTestID(String dataTestId) throws Exception {
        ...
        WebElement element = wait
                .until(webDriver->ExpectedConditions.elementToBeClickable(By.xpath("//*[@data-tests-id='" + dataTestId + "']")).apply(webDriver));
        element.click();
