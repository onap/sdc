...
//--------------------------AMDOCS--------------------------------
        ResourceReqDetails resourceReqDetails = new ElementFactory().getDefaultResourceByType(ResourceTypeEnum.VF, user);//getResourceReqDetails(ComponentConfigurationTypeEnum.DEFAULT);
...
//--------------------------SERVICE--------------------------------
        ServiceReqDetails serviceReqDetails = new ElementFactory().getDefaultService();//getServiceReqDetails(ComponentConfigurationTypeEnum.DEFAULT);
...
//--------------------------getProperties set values and declare--------------------
        ...
        File serviceCsarFileName = new File(File.separator + "ServiceCsar_" + new ElementFactory().generateUUIDforSufix() + ".csar");
...
//		filesFolder = new File(SetupCDTest.getWindowTest().getDownloadDirectory());
        ...
        ResourceReqDetails resourceReqDetails = new ElementFactory().getDefaultResourceByType(resourceType, user);
...
/*	@Test
	public void allottedResourceModelTest() throws Exception{
		...
		ResourceReqDetails resourceReqDetails = new ElementFactory().getDefaultResource(ResourceCategoryEnum.ALLOTTED_RESOURCE_SERVICE_ADMIN);
		resourceReqDetails = createCustomizedVsp(resourceReqDetails, filePath, vnfFile);
