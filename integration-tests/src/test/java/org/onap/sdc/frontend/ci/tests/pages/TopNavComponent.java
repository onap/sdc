...
public class TopNavComponent extends AbstractPageObject {
    ...
    public void clickOnHome() {
        ...
        getWait().until(webDriver->ExpectedConditions.visibilityOfElementLocated(homeButtonLocator).apply(webDriver));
        getWait().until(webDriver->ExpectedConditions.elementToBeClickable(homeButtonLocator).apply(webDriver)).click();
        getWait()
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(REPOSITORY_ICON.getXpath())).apply(webDriver));
    }
    ...
    public WebElement hoverToBreadcrumbArrow(final int arrowPosition) {
        ...
        final List<WebElement> arrowElementList = getWait()
            .until(
                    webDriver->ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(ARROW_DROPDOWN.getXpath())).apply(webDriver));
