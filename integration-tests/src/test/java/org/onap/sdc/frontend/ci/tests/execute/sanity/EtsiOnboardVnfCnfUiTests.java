...
import org.onap.sdc.frontend.ci.tests.flow.ComponentFlow;
...
public class EtsiOnboardVnfCnfUiTests extends SetupCDTest {
    ...
    public void runOnboardEtsiVnfCnf(final String resourceName, final String rootFolder, final String vnfCnfFile) {
        ...
        final ComponentPage componentPage = loadComponentPage().getLandedPage()
     ...
     */
    private ComponentFlow loadComponentPage() {
        final ComponentFlow componentFlow = new ComponentFlow(webDriver);
        componentFlow.run();
        return componentFlow;
    }
