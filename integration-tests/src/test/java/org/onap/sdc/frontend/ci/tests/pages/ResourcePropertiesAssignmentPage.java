...
public class ResourcePropertiesAssignmentPage extends AbstractPageObject {
    ...
    public void isLoaded() {
        wrappingElement = getWait(5)
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(MAIN_DIV.getXpath())).apply(webDriver));
        getWait(5)
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(TITLE_DIV.getXpath())).apply(webDriver));
    }
    ...
    public List<String> getSoftwareVersionProperty() {
        ...
        getWait(5).until(webDriver->ExpectedConditions.visibilityOfElementLocated(swVersionCheckboxLocator).apply(webDriver));
    ...
    private void waitPropertiesToLoad() {
        getWait(5)
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(PROPERTIES_TABLE.getXpath())).apply(webDriver));
        getWait(5)
            .until(webDriver->ExpectedConditions.invisibilityOfElementLocated(By.xpath(NO_DATA_MESSAGE.getXpath())).apply(webDriver));
    }
