...
//			write result to csv file
    ...
    private void loginToSimulator(UserRoleEnum role) {
        ...
        wait.until(webDriver->ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//*[@method='" + "post" + "']"))).apply(webDriver));
        ...
        wait.until(webDriver->ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[@value='" + "Login" + "']"))).apply(webDriver)).click();
    }
