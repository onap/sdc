...
public class CompositionIntTests extends SetupCDTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(CompositionIntTests.class);
    ...
    @Test(dataProviderClass = OnboardingDataProviders.class, dataProvider = "intVFC", dependsOnMethods = "importDataType")
    ...
    private void verifyVFC() throws Exception {
        ...
        final Map<String, Object> simpleVFCTosca = getMapEntry(nodeTypesTosca, "org.openecomp.resource.IntVFC");
    ...
    private Object[][] compositionProperties() {
        return new Object[][]{
            ...
            new Object[]{"int_prop_1", ToscaFunction.GET_PROPERTY, vfcs.get(0).getName() + " 0", "ComplexProp->int_prop"},
            // get_attribute referencing a sub property of an instance property
            new Object[]{"int_prop_2", ToscaFunction.GET_ATTRIBUTE, vfcs.get(0).getName() + " 0", "ComplexProp->int_prop"},
            new Object[]{"EqualIntProp", ToscaFunction.GET_INPUT, null, "VF_INT_INPUT_2"},
            new Object[]{"validValueIntProp", ToscaFunction.YAML, null, "value: 125"}
        };
    }
