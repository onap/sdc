...
public class VFCIntTests extends SetupCDTest {
    ...
    @Test(dependsOnMethods = "addPropertiesToVF")
    private void addGetPropReferenceSelf() throws InterruptedException {
        homePage.isLoaded();
        ...
        propertiesAttributesTab.clickOnProperty("GreaterIntProp");

        PropertiesPage.getPropertyPopup().setToscaDefaultValue(ToscaFunction.GET_PROPERTY, "SELF", "VF_INT_PROP_1");
    }

    // TODO: Add VFC Property Tests get_property referencing a property of in instance property
    // TODO: Add VFC Property Tests get_property referencing a sub property of an instance property
    // TODO: Add VFC Property Tests get_attribute referencing a SELF property
    // TODO: Add VFC Property Tests get_attribute referencing a property of in instance property
    // TODO: Add VFC Property Tests get_attribute referencing a sub property of an instance property
    // TODO: Add VFC Property Tests get_input
