...
public class OnboardHomePage extends AbstractPageObject {
    ...
    public void isLoaded() {
        ...
        createNewVspBtn = getWait()
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(ADD_NEW_VSP_BTN.getXpath())).apply(webDriver));
        getWait()
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(ADD_NEW_VLM_BTN.getXpath())).apply(webDriver));
    }
