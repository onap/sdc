...
public class NotificationHelper {
    ...
    private void waitForVisibility(By messageLocator, final int timeout) {
        getWait(timeout)
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(messageLocator).apply(webDriver));
    }

    private void waitForInvisibility(By messageLocator, int timeout) {
        getWait(timeout)
            .until(webDriver->ExpectedConditions.invisibilityOfElementLocated(messageLocator).apply(webDriver));
    }
