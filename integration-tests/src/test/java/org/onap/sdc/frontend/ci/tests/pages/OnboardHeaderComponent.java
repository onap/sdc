...
public class OnboardHeaderComponent extends AbstractPageObject {
    ...
    public void isLoaded() {
        ...
        getWait()
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(WORKSPACE_TAB_DIV.getXpath())).apply(webDriver));
        getWait()
            .until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(ONBOARD_TAB_DIV.getXpath())).apply(webDriver));
    }
