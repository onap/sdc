...
public final class GeneralUIUtils {
    ...
    public static WebElement getWebElementByTestID(final String dataTestId, final int timeout) {
        try {
            ...
            return wait.until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(TEST_ID_XPATH, dataTestId))).apply(webDriver));
        }
    ...
    public static WebElement getWebElementBy(By by, int timeOut) {
        ...
        return wait.until(webDriver->ExpectedConditions.visibilityOfElementLocated(by).apply(webDriver));
    }
    ...
    public static List<WebElement> getWebElementsListBy(By by, int timeOut) {
        WebDriverWait wait = new WebDriverWait(getDriver(), timeOut);
        return wait.until(webDriver->ExpectedConditions.visibilityOfAllElementsLocatedBy(by).apply(webDriver));
    }
    ...
    public static List<WebElement> getWebElementsListByContainTestID(final String dataTestId) {
        try {
            ...
            return wait.until(webDriver->ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(xpath)).apply(webDriver));
        } catch (final Exception e) {
    ...
    public static List<WebElement> getWebElementsListByContainsClassName(final String containedText) {
        ...
        return wait.until(webDriver->ExpectedConditions.
            presenceOfAllElementsLocatedBy(By.xpath(String.format("//*[contains(@class, '%s')]", containedText))).apply(webDriver));
    }
    ...
    public static WebElement getWebElementByClassName(String className) {
        ...
        return wait.until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.className(className)).apply(webDriver));
    }

    public static List<WebElement> getWebElementsListByTestID(String dataTestId) {
        WebDriverWait wait = new WebDriverWait(getDriver(), TIME_OUT);
        return wait.until(webDriver->ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(String.format(TEST_ID_XPATH, dataTestId))).apply(webDriver));
    }

    public static List<WebElement> getWebElementsListByClassName(String className) {
        WebDriverWait wait = new WebDriverWait(getDriver(), TIME_OUT);
        return wait.until(webDriver->ExpectedConditions.visibilityOfAllElementsLocatedBy(By.className(className)).apply(webDriver));
    }
    ...
    public static Boolean isElementInvisibleByTestId(String dataTestId) {
        ...
        return wait.until(webDriver->
                ExpectedConditions.invisibilityOfElementLocated(By.xpath(String.format(TEST_ID_XPATH, dataTestId))).apply(webDriver));
    }

    public static Boolean isElementVisibleByTestId(String dataTestId) {
        try {
            WebDriverWait wait = new WebDriverWait(getDriver(), TIME_OUT);
            return wait.until(webDriver->ExpectedConditions.visibilityOfElementLocated((By.xpath(String.format(TEST_ID_XPATH, dataTestId)))).apply(webDriver)).isDisplayed();
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public static void clickOnElementByTestIdWithoutWait(final String dataTestId) {
        try {
            ...
            wait.until(webDriver->ExpectedConditions
                    .elementToBeClickable(By.xpath(String.format(TEST_ID_XPATH, dataTestId))).apply(webDriver)).click();
    ...
    public static void clickOnElementByInputTestIdWithoutWait(final String dataTestId) {
        ...
        wait.until(webDriver->ExpectedConditions.elementToBeClickable(By.xpath(xPath)).apply(webDriver)).click();
    }
    ...
    public static void clickOnElementByTestId(String dataTestId, int customTimeout) {
        ...
        wait.until(webDriver->ExpectedConditions.elementToBeClickable(By.xpath(String.format(TEST_ID_XPATH, dataTestId))).apply(webDriver)).click();
    }
    ...
    public static Boolean waitForElementInVisibilityByTestId(String dataTestId, int timeOut) {
        ...
        if (!displayed) {
            return wait.until(webDriver->ExpectedConditions.invisibilityOfElementLocated(By.xpath(String.format(TEST_ID_XPATH, dataTestId))).apply(webDriver));
        }
        return false;
    }
    ...
    public static Boolean waitForElementInVisibilityBy(By by, int timeOut) {
        ...
        if (!displayed) {
            Boolean until = wait.until(webDriver->ExpectedConditions.invisibilityOfElementLocated(by).apply(webDriver));
    ...
    public static void clickOnElementByText(String textInElement) {
        WebDriverWait wait = new WebDriverWait(getDriver(), TIME_OUT);
        highlightMyElement(wait.until(webDriver->
                ExpectedConditions.elementToBeClickable(findByText(textInElement)).apply(webDriver))).click();
    }
    ...
    public static void waitForAngular() {
        ...
        wait.until(webDriver->AdditionalConditions.pageLoadWait().apply(webDriver));
        wait.until(webDriver->AdditionalConditions.angularHasFinishedProcessing().apply(webDriver));
    ...
    public static WebElement getClickableButtonBy(By by, int timout) {
        try {
            ...
            return wait.until(webDriver->ExpectedConditions.elementToBeClickable(by).apply(webDriver));
        } catch (Exception e) {
            return null;
        }
    }
    ...
    public static void clickOnElementByCSS(String cssString) throws Exception {
        WebDriverWait wait = new WebDriverWait(getDriver(), TIME_OUT);
        wait.until(webDriver->ExpectedConditions.visibilityOfElementLocated(By.cssSelector(cssString)).apply(webDriver)).click();
        ultimateWait();
    }
