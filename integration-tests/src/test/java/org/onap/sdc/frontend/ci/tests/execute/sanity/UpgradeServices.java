...
public class UpgradeServices extends SetupCDTest {
    ...
    public void upgradeAllottedVfOnServiceLevel() throws Throwable {
        ...
        ResourceReqDetails vfcMetaData = new ElementFactory().getDefaultResourceByTypeNormTypeAndCatregory(ResourceTypeEnum.VFC, NormativeTypesEnum.ROOT,
    ...
    private Service createService() throws Exception {
        ServiceReqDetails serviceReqDetails1 = new OnboardingUtilsViaApis().prepareServiceDetailsBeforeCreate(sdncDesignerDetails);
    ...
    private Resource createAndCertifyVFfromVSP(String vnfFile) throws Exception {
        ...
        Resource vfResource = new OnboardingUtilsViaApis().createResourceFromVSP(resourceReqDetails);
    ...
    private ResourceReqDetails createCRAndCertify() throws Exception {
        ResourceReqDetails crMetaData = new ElementFactory().getDefaultResourceByType(ResourceTypeEnum.CR, getUser());
    ...
    private ResourceReqDetails createVFviaAPI(ResourceCategoryEnum resourceCategory) {
        ResourceReqDetails vfMetaData = new ElementFactory().getDefaultResourceByTypeNormTypeAndCatregory(ResourceTypeEnum.VF, NormativeTypesEnum.ROOT, resourceCategory, getUser());
