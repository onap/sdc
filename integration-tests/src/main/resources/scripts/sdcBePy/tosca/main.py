...
def parse_param():
    ...
    return [args.conf, 'https' if args.https else 'http',
            args.ip, args.port, args.header, args.adminUser,
            args.debug]
...
def get_args():
    ...
    conf_path, scheme, be_host, be_port, header, admin_user, debug = parse_param()
    ...
    return scheme, be_host, be_port, header, admin_user, debug


def parse_and_create_proxy():
    scheme, be_host, be_port, header, admin_user, debug = get_args()
