...
public class PolicyTypeBusinessLogicTest {
    ...
    public void createPolicyByYaml() {
        when(policyTypeImportManager.createPolicyTypes(any(ToscaTypeImportData.class), any(String.class), any(boolean.class))).thenReturn(null);
        testInstance.createPolicyTypeFromYaml("test", "test", true);
        verify(policyTypeImportManager, Mockito.times(1)).createPolicyTypes(any(ToscaTypeImportData.class), any(String.class), any(boolean.class));
    }
