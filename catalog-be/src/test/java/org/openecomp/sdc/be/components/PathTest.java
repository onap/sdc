...
public class PathTest extends BaseServiceBusinessLogicTest {
    ...
    public void validateSerialization() throws IOException {
        ...
        Either<Service, ResponseFormat> serviceResponseFormatEither = new ComponentsUtils().convertJsonToObjectUsingObjectMapper(jsonResult, user, Service.class, AuditingActionEnum.CREATE_RESOURCE, ComponentTypeEnum.SERVICE);
