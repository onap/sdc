...
public class CapabilityRequirementConverterTest {
    ...
    @Spy
    ComponentInstance instanceProxy = new ComponentInstance();
    @Spy
    ComponentInstance vfInstance = new ComponentInstance();
    @Spy
    Component vfComponent = new Resource();
    @Spy
    ComponentInstance vfcInstance = new ComponentInstance();
    @Spy
    Component vfcComponent = new Resource();
    ...
    public Component getOrigin(ComponentInstance instance) {
        // region proxy
    ...
    public Map<String, Component> populateInstanceAndGetCache(Component proxyOrigin,
