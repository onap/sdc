...
public class PolicyServletTest extends JerseySpringBaseTest{
    ...
    public void updatePolicyPropertiesFailure() {
        ...
        Response policyProps = buildUpdatePropertiesRequest(ComponentTypeEnum.SERVICE_PARAM_NAME, properties).invoke(new GenericType<Response>() {});
    ...
    private Map<PolicyTargetType, List<String>> getTargetList() {
