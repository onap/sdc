...
public class UserMessageTest {
    ...
    private static final String STRING_REPRESENTATION = "UserMessage [operation=CREATE, userId=mock-user, role=mock-role]";
    ...
    public void testToString() {
        UserMessage userMessage = createUserMessage();
        assertThat(userMessage.toString(), is(STRING_REPRESENTATION));
    }
