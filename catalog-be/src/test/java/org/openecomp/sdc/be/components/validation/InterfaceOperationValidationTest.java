...
public class InterfaceOperationValidationTest implements InterfaceOperationTestUtils {
    ...
    private ListDataDefinition<OperationInputDefinition> operationInputDefinitionList = createMockOperationInputDefinitionList();
    @Before
    public void init() {
    ...
    private ListDataDefinition<OperationInputDefinition> createMockOperationInputDefinitionList() {
        ListDataDefinition<OperationInputDefinition> operationInputDefinitionList = new ListDataDefinition<>();
        OperationInputDefinition operationInputDefinition1 = new OperationInputDefinition();
        operationInputDefinition1.setLabel("Label");
        operationInputDefinitionList.add(operationInputDefinition1);
