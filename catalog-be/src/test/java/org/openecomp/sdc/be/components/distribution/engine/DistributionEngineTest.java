...
public class DistributionEngineTest {
    ...
    @Mock
    DistributionDeleteNotifcationSender distributionDeleteNotifcationSender;
    ...
    void testNotifyServiceForDelete() {
        ...
        when(distributionDeleteNotifcationSender.sendNotificationForDeleteService(
        ...
        verify(distributionDeleteNotifcationSender, times(1)).sendNotificationForDeleteService(
                eq(expectedTopicName), eq(distributionId), any(EnvironmentMessageBusData.class),
                eq(notificationData));
    }
