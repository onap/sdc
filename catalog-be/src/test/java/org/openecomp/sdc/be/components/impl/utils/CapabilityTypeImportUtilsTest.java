...
public class CapabilityTypeImportUtilsTest {
    ...
    public void testGivenSameType_returnsTrue(){
        Assert.assertTrue(CapabilityTypeImportUtils.isCapabilityTypesEquals(type1, type1));
    }
    ...
    public void testGivenEqualCapabilitiesWithParams_thenReturnsTrue(){
        ...
        Assert.assertTrue(CapabilityTypeImportUtils.isCapabilityTypesEquals(type1, type2));
    }
