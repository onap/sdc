...
class ExternalRefServletTest extends JerseyTest {
    ...
    private static final HealingJanusGraphGenericDao janusGraphGenericDao = Mockito
        .mock(HealingJanusGraphGenericDao.class);
    ...
    /* Users */
    private static User adminUser = new User("admin", "admin", "admin", "admin@email.com", Role.ADMIN.name(),
        System.currentTimeMillis());
    private static User designerUser = new User("designer", "designer", "designer", "designer@email.com",
        Role.DESIGNER.name(), System
        .currentTimeMillis());
    private static User otherDesignerUser = new User("otherDesigner", "otherDesigner", "otherDesigner",
        "otherDesigner@email.com", Role.DESIGNER
        .name(), System.currentTimeMillis());
    private static User otherUser = new User("other", "other", "other", "other@email.com", Role.DESIGNER.name(),
        System.currentTimeMillis());
    ...
    public void before() throws Exception {
        ...
        when(toscaOperationFacadeMock.getComponentByUuidAndVersion(eq(serviceVertexUuid), eq(VERSION)))
            .thenReturn(Either.left(serviceComponentMock));
        when(toscaOperationFacadeMock.getComponentByUuidAndVersion(eq(resourceVertexUuid), eq(VERSION)))
