...
class ServiceImportBusinessLogicTest extends ServiceImportBussinessLogicBaseTestSetup {
    ...
    private final ServiceImportParseLogic serviceImportParseLogic = Mockito.mock(ServiceImportParseLogic.class);
    private final ArtifactDefinition artifactDefinition = Mockito.mock(ArtifactDefinition.class);
