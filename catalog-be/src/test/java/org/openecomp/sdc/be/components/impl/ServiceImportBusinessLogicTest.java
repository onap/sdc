...
class ServiceImportBusinessLogicTest extends ServiceImportBussinessLogicBaseTestSetup {
    ...
    void testCreateService_OK() {
        ...
        when(toscaOperationFacade.getLatestByToscaResourceName(contains("org.openecomp.resource"), isNull())).thenReturn(Either.left(new Resource()));
        when(toscaOperationFacade.getLatestByToscaResourceName(contains("tosca.nodes."), isNull())).thenReturn(Either.left(new Resource()));
