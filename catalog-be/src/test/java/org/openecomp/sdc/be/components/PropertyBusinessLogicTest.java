...
public class PropertyBusinessLogicTest {
    ...
    public void isPropertyUsedByComponentInterface(){
        Service service = new Service();
        service.setUniqueId(serviceId);
        service.setInterfaces(InterfaceOperationTestUtils.createMockInterfaceTypeMap(interfaceType, operationType));

        PropertyDefinition propDef1 = new PropertyDefinition();
        propDef1.setUniqueId("inputId1");
    ...
    public void isPropertyUsedByComponentInstanceInterface(){
        Map<String, InterfaceDefinition> newInterfaceDefinition = InterfaceOperationTestUtils.createMockInterfaceTypeMap(interfaceType, operationType);
        ComponentInstanceInterface componentInstanceInterface = new ComponentInstanceInterface("TestService", newInterfaceDefinition.get(interfaceType));
