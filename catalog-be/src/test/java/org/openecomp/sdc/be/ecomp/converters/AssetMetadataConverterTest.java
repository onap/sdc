...
public class AssetMetadataConverterTest {
    ...
    public void testConvertToMetadata() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.convertToMetadata(ComponentTypeEnum.RESOURCE, serverBaseURL,  detailed, curr);
        assertThat(result.isLeft()).isTrue();
    }
    ...
    public void testGenerateResourceMeatdata() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.generateResourceMeatdata(serverBaseURL, true, curr);
        assertThat(result.isLeft()).isTrue();
    }
    ...
    public void testCreateMetadaObject() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.createMetadaObject(true, ComponentTypeEnum.RESOURCE);
    ...
    public void testGenerateServiceMetadata() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.generateServiceMetadata(serverBaseURL, detailed, curr);
        assertThat(result.isLeft()).isTrue();
    }
    ...
    public void testConvertToAsset() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.convertToAsset(asset, component, serverBaseURL, true);
    ...
    public void testConvertToResourceMetadata() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.convertToResourceMetadata(assetToPopulate, resource, serverBaseURL, true);
        assertThat(result).isInstanceOf(ResourceAssetMetadata.class);
    }
    ...
    public void testConvertToServiceAssetMetadata() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.convertToServiceAssetMetadata(assetToPopulate, service, serverBaseURL, true);
    ...
    public void testConvertToResourceDetailedMetadata() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.convertToResourceDetailedMetadata(assetToPopulate, resource, serverBaseURL);
        assertThat(result.isLeft()).isTrue();
    }
    ...
    public void testConvertToServiceDetailedMetadata() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.convertToServiceDetailedMetadata(assetToPopulate, service);
        assertThat(result.isLeft()).isTrue();
    }
    ...
    public void testPopulateResourceWithArtifacts() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.populateResourceWithArtifacts(asset, resource, artifacts);
    ...
    public void testPopulateServiceWithArtifacts() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.populateServiceWithArtifacts(asset, service, artifacts);
    ...
    public void testPopulateAssetWithArtifacts() throws Exception {
        ...
        // test 1
        testSubject = createTestSubject();
        result = testSubject.populateAssetWithArtifacts(component, artifacts);
    ...
    public void testConvertToArtifactMetadata() throws Exception {
        ...
        // test 1
        testSubject = createTestSubject();
        result = testSubject.convertToArtifactMetadata(artifact, componentType, componentUUID, resourceInstanceName);
    ...
    public void testConvertToResourceInstanceMetadata() throws Exception {
        ...
        // default test
        testSubject = createTestSubject();
        result = testSubject.convertToResourceInstanceMetadata(componentInstances, componentType, componentUUID);
        assertThat(result.isLeft()).isTrue();
    }
}
