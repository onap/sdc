...
public class DataTypeBusinessLogicTest {
    ...
    public void testCreateDataType() {
        ...
        final DataTypeDefinition actualDataType = dataTypeBusinessLogic.create(dataTypeDefinition);
        assertThat("Result should not be null", actualDataType, is(not(nullValue())));
        assertThat("Result should contains expected data type definition",
            actualDataType, equalTo(dataTypeDefinition));
        assertThat("The creation time should not be null", actualDataType.getCreationTime(), is(notNullValue()));
