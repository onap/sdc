...
public class DataTypeBusinessLogicTest {
    ...
    public void createDataTypeByYaml() {
        when(dataTypeImportManager.createDataTypes(any(String.class), any(String.class), any(boolean.class))).thenReturn(null);
        testInstance.createDataTypeFromYaml("test", "test", true);
        verify(dataTypeImportManager, Mockito.times(1)).createDataTypes(any(String.class), any(String.class), any(boolean.class));
    }
