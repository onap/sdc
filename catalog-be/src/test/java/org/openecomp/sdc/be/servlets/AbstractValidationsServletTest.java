...
public class AbstractValidationsServletTest {
    ...
    private static GroupBusinessLogic groupBL = mock(GroupBusinessLogic.class);
    ...
    private static AbstractValidationsServlet servlet = new ArtifactExternalServlet(userBusinessLogic, groupBL, componentInstanceBL, componentsUtils, servletUtils,
