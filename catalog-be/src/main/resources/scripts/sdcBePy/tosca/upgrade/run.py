...
def main(sdc_be_proxy):
    ...
    logger.log("Starting phase: heat and normative types")
    ...
    logger.log("Finished phase: heat and normative types")

    logger.log("Starting phase: onap/sol types")
