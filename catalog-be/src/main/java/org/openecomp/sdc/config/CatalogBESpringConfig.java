...
public class CatalogBESpringConfig {
    ...
    public DefaultCsarGenerator defaultCsarGenerator(ToscaOperationFacade toscaOperationFacade,
        ...
        return new DefaultCsarGenerator(toscaOperationFacade,
            componentsUtils, toscaExportUtils, generators, artifactCassandraDao,
            sdcSchemaFilesCassandraDao,modelOperation);
    }
