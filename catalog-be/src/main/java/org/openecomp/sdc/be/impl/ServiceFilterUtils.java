...
public class ServiceFilterUtils {
    ...
    private static ImmutableSetMultimap.Builder<String, String> initMap(
            ImmutableSetMultimap.Builder<String, String> builder, UIConstraint uiConstraint) {
        String value = uiConstraint.getValue().toString().trim();
        if (!StringUtils.isEmpty(value)) {
            return (builder.put(uiConstraint.getSourceName(), value));
        }
        return builder;
    }
