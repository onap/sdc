...
public class SdcKafkaConsumer {
    ...
    /**
     *
     * @param topics Topic in which to subscribe
     */
    ...
    /**
     *
     * @return The list of records returned from the poll, for a specified topic
     */
    ...
    /**
     *
     * @return A list of topics for this consumer
     */
