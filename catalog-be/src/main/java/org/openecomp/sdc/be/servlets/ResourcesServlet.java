...
public class ResourcesServlet extends AbstractValidationsServlet {
    ...
    @Inject
    public ResourcesServlet(ComponentInstanceBusinessLogic componentInstanceBL,
    ...
    @Operation(description = "Create Resource", method = "POST", summary = "Returns created resource", responses = {
            ...
            @ApiResponse(responseCode = "403", description = "Restricted operation / Tenant not permitted"),
    ...
    public Response createResource(@Parameter(description = "Resource object to be created", required = true) String data,
        ...
        try {
            ...
            // UI Create
                ...
                if (!TenantGuard.fromCatalogConfiguration().permits(request, resource.getTenant())) {
                    log.debug("Tenant {} not permitted for user {}", resource.getTenant(), userId);
