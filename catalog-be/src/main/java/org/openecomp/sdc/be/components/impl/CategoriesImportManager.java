...
import static org.openecomp.sdc.be.dao.neo4j.GraphPropertiesDictionary.HIDE;
...
public class CategoriesImportManager {
    ...
    private List<CategoryDefinition> createServiceCategories(final Map<String, Object> categories) {
        ...
        for (Entry<String, Object> entry : categories.entrySet()) {
            ...
            final Object hide = category.get(HIDE.getProperty());
            catDef.setHide(hide != null && (boolean) hide);
