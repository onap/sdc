...
public class ComponentInstanceOutputsRedeclareHandler {
    ...
    public ActionStatus redeclareComponentOutputsForInstance(Component container, String newInstanceId, List<OutputDefinition> oldOutputs) {
        ...
        Map.Entry<String, List<AttributeDataDefinition>> allAttributesForInstance = getAllGetAttributesForInstance(container, newInstanceId);
        List<OutputDefinition> previouslyDeclaredOutputs = declaredOutputsResolver
            .getPreviouslyDeclaredOutputsToMerge(oldOutputs, allAttributesForInstance);
    ...
    private Map.Entry<String, List<AttributeDataDefinition>> getAllGetAttributesForInstance(Component newComponent, String instanceId) {
        ...
        return Map.entry(instanceId, allInstanceAttributes);
    }
