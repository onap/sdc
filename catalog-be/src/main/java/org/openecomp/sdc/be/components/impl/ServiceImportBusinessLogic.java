...
public class ServiceImportBusinessLogic {
    ...
    protected void processComponentInstance(final String yamlName,
                                            final Resource resource,
                                            final List<ComponentInstance> componentInstancesList,
                                            final Either<Map<String, DataTypeDefinition>, JanusGraphOperationStatus> allDataTypes,
                                            final Map<String, List<ComponentInstanceProperty>> instProperties,
                                            final Map<ComponentInstance, Map<String, List<CapabilityDefinition>>> instCapabilties,
                                            final Map<ComponentInstance, Map<String, List<RequirementDefinition>>> instRequirements,
                                            final Map<String, Map<String, ArtifactDefinition>> instDeploymentArtifacts,
                                            final Map<String, Map<String, ArtifactDefinition>> instArtifacts,
                                            final Map<String, List<AttributeDefinition>> instAttributes,
                                            final Map<String, Resource> originCompMap,
                                            final Map<String, List<ComponentInstanceInput>> instInputs,
                                            final UploadComponentInstanceInfo uploadComponentInstanceInfo) {
        final Optional<ComponentInstance> currentCompInstanceOpt = componentInstancesList.stream()
        ...
        final ComponentInstance currentCompInstance = currentCompInstanceOpt.get();
        final String resourceInstanceId = currentCompInstance.getUniqueId();
        final Resource originResource = getOriginResource(yamlName, originCompMap, currentCompInstance);
        ...
        if (originResource.getResourceType() != ResourceTypeEnum.VF) {
            final ResponseFormat addPropertiesValueToRiRes = addPropertyValuesToRi(uploadComponentInstanceInfo, resource,
    ...
    protected void addInputsValuesToRi(final UploadComponentInstanceInfo uploadComponentInstanceInfo,
                                       final Resource resource,
                                       final Resource originResource,
                                       final ComponentInstance currentCompInstance,
                                       final Map<String, List<ComponentInstanceInput>> instInputs,
        ...
        try {
            if (MapUtils.isNotEmpty(propMap)) {
                final Map<String, InputDefinition> currPropertiesMap = new HashMap<>();
                final List<ComponentInstanceInput> instPropList = new ArrayList<>();
