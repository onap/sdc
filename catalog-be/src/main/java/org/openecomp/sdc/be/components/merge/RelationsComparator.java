...
public class RelationsComparator {
    ...
    private boolean findRelation(Resource oldResource, List<RequirementCapabilityRelDef> oldRelations, Resource newResource, RequirementCapabilityRelDef newRelation) {
        for (RequirementCapabilityRelDef oldRelation : oldRelations) {
            RequirementAndRelationshipPair oldRelationship = oldRelation.getSingleRelationship();
            RequirementAndRelationshipPair newRelationship = newRelation.getSingleRelationship();
    ...
    private boolean isRelationEqual(RequirementAndRelationshipPair oldRelationship, RequirementAndRelationshipPair newRelationship) {
    ...
    private boolean isRelationshipCapabilityEquals(RequirementAndRelationshipPair oldRelationship, RequirementAndRelationshipPair newRelationship) {
    ...
    private boolean isRelationshipTypeEquals(RequirementAndRelationshipPair oldRelationship, RequirementAndRelationshipPair newRelationship) {
        return oldRelationship.getRelationship().getType().equals(newRelationship.getRelationship().getType());
    }

    private boolean isRelationshipReqNameEquals(RequirementAndRelationshipPair oldRelationship, RequirementAndRelationshipPair newRelationship) {
