...
public class AssetsDataServlet extends AbstractValidationsServlet {
    ...
    public Response getAssetListExternal(
            ...
            @Parameter(description = "The filter key (for resources and services)") @QueryParam("category") String category,
            ...
            @Parameter(description = "The filter key (only for services). \n" +
                    ...
                    "Examples:\n" +
                    "http://127.0.0.1:8080/sdc/v1/catalog/services?version=highestMatchingVersionOnly:true\n" +
                    "http://127.0.0.1:8080/sdc/v1/catalog/services?version=lessThan:2.1\n" +
                    "http://127.0.0.1:8080/sdc/v1/catalog/services?version=greaterThan:2\n" +
                    "http://127.0.0.1:8080/sdc/v1/catalog/services?version=equals:2")
            @QueryParam("version") String version,
            @Parameter(description = "The filter key (only for services)\n" +
                    "Syntax: /services?metadata=<KEY1>:<VALUE1>&metadata=<KEY2>:<VALUE2> ..." +
                    "Example:\n" +
                    "http://127.0.0.1:8080/sdc/v1/catalog/services?metadata=ETSI Version:3.3.1")
