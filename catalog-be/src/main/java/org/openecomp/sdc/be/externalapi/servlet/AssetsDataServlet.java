            ...
            @Parameter(description = "The filter key (only for services). \n" +
                    ...
                    examples = {
                            @ExampleObject(
                                    ...
                                    value = "http://127.0.0.1:8080/sdc/v1/catalog/services?version=highestMatchingVersionOnly:true"),
                            @ExampleObject(
                                    name = "An example request to get all services with version less than 2.1",
                                    value = "http://127.0.0.1:8080/sdc/v1/catalog/services?version=lessThan:2.1"),
                            @ExampleObject(
                                    name = "An example request to get all services with version equal 2.0",
                                    value = "http://127.0.0.1:8080/sdc/v1/catalog/services?version=equals:2.0"),
                            @ExampleObject(
                                    name = "An example request to get all services with version greater than 1.1",
                                    value = "http://127.0.0.1:8080/sdc/v1/catalog/services?version=greaterThan:1.1")})
