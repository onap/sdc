...
public class ServiceFilterServlet extends AbstractValidationsServlet {
    ...
    private static final String FAILED_TO_UPDATE_OR_CREATE_PATHS = "failed to update or create paths";
    private static final String FAILED_TO_PARSE_SERVICE = "failed to parse service";
    private static final String FORWARD_PATH_CREATION_OR_UPDATE = "Forward Path Creation or update";
    private static final String CREATE_OR_UPDATE_FORWARDING_PATH_WITH_AN_ERROR =
            "create or update forwarding path with an error";
    ...
    public Response addServiceFilterConstraint(@ApiParam(value = "Service data", required = true) String data,
        ...
        try {
            ...
            if (actionResponse.isRight()) {
                log.debug(FAILED_TO_UPDATE_OR_CREATE_PATHS);
            ...
            BeEcompErrorManager.getInstance().logBeRestApiGeneralError(FORWARD_PATH_CREATION_OR_UPDATE);
            log.debug(CREATE_OR_UPDATE_FORWARDING_PATH_WITH_AN_ERROR, e);
