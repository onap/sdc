        ...
        for (Entry<String, CINodeFilterDataDefinition> filter : instNodeFilter.entrySet()) {
            ...
            if (!properties.isEmpty()) {
                properties.forEach(property -> {
                    ...
                    nodeFilterOperation.addNewProperty(componentId, componentInstanceId, nodeFilter.left().value(),
            ...
            if (!capabilities.isEmpty()) {
                capabilities.forEach(capability -> {
                    ...
                    nodeFilterOperation.addNewCapabilities(componentId, componentInstanceId, nodeFilter.left().value(),
