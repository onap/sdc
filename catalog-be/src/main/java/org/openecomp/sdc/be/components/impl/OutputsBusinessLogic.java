...
public class OutputsBusinessLogic extends BaseBusinessLogic {
    ...
    public Either<List<OutputDefinition>, ResponseFormat> createOutputsInGraph(Map<String, OutputDefinition> outputs,
        ...
        for (Map.Entry<String, OutputDefinition> outputDefinition : outputs.entrySet()) {
            String outputName = outputDefinition.getKey();
            outputDefinition.getValue().setName(outputName);
        }
        ...
        Either<List<OutputDefinition>, StorageOperationStatus> associateOutputsEither = toscaOperationFacade
            .createAndAssociateOutputs(outputs, component.getUniqueId());
