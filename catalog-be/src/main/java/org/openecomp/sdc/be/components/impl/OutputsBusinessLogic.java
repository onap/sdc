...
//                                final List<ComponentInstanceAttribOutput> componentInstanceAttribOutputs = new ArrayList<>();
//                                componentInstanceAttribOutputs.add(new ComponentInstanceAttribOutput(componentInstanceAttribute));
//                                final Map<String, List<ComponentInstanceAttribOutput>> mapComponentInstanceAttribOutput = new HashMap<>();
//                                mapComponentInstanceAttribOutput.put(componentInstance.getUniqueId(), componentInstanceAttribOutputs);
                                ...
                                componentInstOutputsMap.setComponentInstanceAttributes(Collections.singletonMap(componentInstance.getUniqueId(),
                                    Collections.singletonList(new ComponentInstanceAttribOutput(componentInstanceAttribute))));
//                                    Collections.singletonMap(componentInstance.getUniqueId(), componentInstanceAttribOutputs));
//                                componentInstOutputsMap.setComponentInstanceAttributes(mapComponentInstanceAttribOutput);
