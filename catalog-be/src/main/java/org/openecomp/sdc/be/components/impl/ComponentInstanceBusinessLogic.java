 ...
 */
    ...
    public Either<Map<String, List<Object>>, ResponseFormat> copyComponentInstance(String origComponentId,
                                                                                   String componentId, 
                                                                                   String componentInstanceId,
                                                                                   String posX,
                                                                                   String posY,
            ...
            for (ComponentInstanceProperty sourceAttribute : sourceAttributeList) {
                ...
                for (ComponentInstanceProperty destAttribute : destAttributeList) {
                    if (sourceAttributeName.equals(destAttribute.getName())) {
                        ...
                        if (!sourceAttribute.getValue().isEmpty() && !"".equals(sourceAttribute.getValue())) {
