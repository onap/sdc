...
public class CsarUtils {
    ...
    public CsarUtils() {
        this.CONFORMANCE_LEVEL = ConfigurationManager.getConfigurationManager().getConfiguration().getToscaConformanceLevel();
        this.SDC_VERSION=ExternalConfiguration.getAppVersion();
        System.out.println("CsarUtils");
        System.out.println("CONFORMANCE_LEVEL:"+CONFORMANCE_LEVEL);
    ...
    private Either<byte[], ResponseFormat> getLatestSchemaFilesFromCassandra() {
    	System.out.println("versionFirstThreeOctates" + versionFirstThreeOctates);
    	System.out.println("CONFORMANCE_LEVEL" + CONFORMANCE_LEVEL);
    	System.out.println("In CSARUtils: \n" + ConfigurationManager.getConfigurationManager().getConfiguration());
