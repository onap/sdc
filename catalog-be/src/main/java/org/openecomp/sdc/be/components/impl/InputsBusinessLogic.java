...
public class InputsBusinessLogic extends BaseBusinessLogic {
    ...
    public Either<List<InputDefinition>, ResponseFormat> createListInput(String userId, String componentId,
        ...
        try {
            ...
            Either<? extends org.openecomp.sdc.be.model.Component, ResponseFormat> validateComponent =
            ...
            if (StringUtils.isEmpty(listInput.getType())
                ...
                log.debug("#createListInput: Type of list input is not list !");
            ...
            if (StringUtils.isEmpty(desiredTypeName)) {
                log.debug("#createListInput: Schema type of list input is empty!");
            ...
            Either<List<DataTypeDefinition>, StorageOperationStatus> dataTypeResult = toscaOperationFacade
                .addDataTypesToComponent(dataTypesMap, componentId);
    ...
    private DataTypeDefinition preparePrivateDataTypeForListInput(ComponentInstInputsMap inputsMap,
        String dataTypeName) {
