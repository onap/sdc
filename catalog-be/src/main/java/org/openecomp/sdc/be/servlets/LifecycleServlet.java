...
public class LifecycleServlet extends BeGenericServlet {
    ...
    public Response changeResourceState(
        ...
        if (componentType != null) {
            ...
            return buildOkResponse(getComponentsUtils().getResponseFormat(ActionStatus.OK), value);
        } else {
            ...
            return buildErrorResponse(getComponentsUtils().getInvalidContentErrorAndAudit(user, componentId, AuditingActionEnum.CHECKOUT_RESOURCE));
        }
    }
