...
public class ToscaFunctionYamlParsingHandler {
    ...
    private static Optional<ToscaFunction> handleGetPropertyFunction(Map<String, Object> toscaFunctionPropertyValueMap, String functionType,
        ...
        if (propertySourceIndex.size() > 1 && StringUtils.isNumeric(propertySourceIndex.get((propertySourceIndex.size() - 1)))) {
            ...
            toscaGetFunction.setToscaIndex(Integer.parseInt(propertySourceIndex.get((propertySourceIndex.size() - 1))));
        } else {
    ...
    private static Optional<ToscaFunction> handleGetInputFunction(Map<String, Object> toscaFunctionPropertyValueMap, String functionType) {
        ...
        if (functionValueObj instanceof String) {
            ...
            if (functionParameters.size() > 1 && StringUtils.isNumeric(functionParameters.get((functionParameters.size() - 1)))) {
                ...
                toscaGetFunction.setToscaIndex(Integer.parseInt(functionParameters.get((functionParameters.size() - 1))));
            } else {
