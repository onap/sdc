...
public class SoftwareInformationBusinessLogic {
     ...
     */
    public Optional<PropertyDefinition> setSoftwareInformation(final Resource resource, final CsarInfo csarInfo)
        ...
        final PnfSoftwareInformation pnfSoftwareInformation = parseSoftwareInformation(softwareInformationYaml)
            .orElse(null);
        ...
        final String softwareVersionInformation = getPropertyJsonStringValue(versionList,
            ToscaPropertyType.LIST.getType());
