...
public class DefaultCsarGenerator implements CsarZipGenerator {
    ...
    public Either<ZipOutputStream, ResponseFormat> generateCsarZip(
        ...
        return commonCsarGenerator.generateCsarZip(component, getFromCS, zip, isInCertificationRequest, createdBy,
            toscaMetaFileName, isAsdPackage, DEFINITIONS_PATH, true);
    }
