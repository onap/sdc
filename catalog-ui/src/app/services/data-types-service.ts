    ...
    public findAllDataTypesByModel = (modelName: string): Promise<Map<string, DataTypeModel>> => {
        return new Promise<Map<string, DataTypeModel>>((resolve, reject) => {
            this.fetchDataTypesByModel(modelName).then(response => {
                ...
                console.log('findAllDataTypesByModel typeof dataTypes', typeof dataTypes);
                console.log('findAllDataTypesByModel dataTypes', dataTypes);
                ...
                console.log('findAllDataTypesByModel typeof dataTypeMap', typeof dataTypeMap);
                console.log('findAllDataTypesByModel dataTypeMap', dataTypeMap);
                resolve(dataTypeMap);
            }).catch(reason => {
                reject(reason);
            });
