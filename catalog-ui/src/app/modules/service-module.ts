...
import {CombinationService} from "../services/components/combination-service";
...
serviceModule.service('Sdc.Services.Components.CombinationService', CombinationService);
