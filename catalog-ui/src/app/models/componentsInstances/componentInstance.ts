...
export class ComponentInstance implements IComponentInstance{
    ...
    public instanceCountInput: string;
    public instanceCountGetFunctionType: string;
    //custom properties
    ...
    constructor(componentInstance?:ComponentInstance) {
        ...
        if (componentInstance) {
            ...
            this.instanceCountInput = componentInstance.instanceCountInput;
            this.instanceCountGetFunctionType = componentInstance.instanceCountGetFunctionType;
        }
    }
