...
export class CompositionViewModel {
    ...
    private initScope = (): void => {
        ...
        this.$scope.isNotCombination = (): boolean => {
            if (this.$scope.currentComponent && this.$scope.currentComponent.isResource()) {
                return this.$scope.currentComponent.getComponentSubType() !== 'Combination';
            }
            else {
                return true;
            }
