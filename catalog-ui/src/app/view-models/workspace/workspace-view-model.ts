...
export class WorkspaceViewModel {
    ...
    private initScope = (): void => {
        ...
        this.$scope.handleDeleteArchivedComponent = (): void => {
            let type: string = this.$scope.component.componentType;
            if(type == "SERVICE") {
                const modalTitle: string = "Delete All Versions?";
                const modalMessage: string = "Delete all versions of this service?";
                const modalButton = {
                    testId: 'OK',
                    text: this.sdcMenu.alertMessages.okButton,
                    type: SdcUiCommon.ButtonType.warning,
                    callback: this.$scope.handleDeleteArchivedService,
                    closeModal: true
