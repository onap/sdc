...
interface IPaletteScope extends IScope {
    ...
    isShowDashLine: (displayComponent: LeftPaletteComponent) => boolean;
    isOnDrag: boolean;
    isDragable: boolean;
    isLoading: boolean;
    isViewOnly: boolean;
    ...
    private initEvents(scope: IPaletteScope) {
        ...
        scope.onMouseOver = (displayComponent: LeftPaletteComponent, sectionElem: HTMLElement) => {
            if (this.isGroupOrPolicy(displayComponent)) {
                ...
                if (displayComponent.getComponentSubType() == "Combination") {
                    scope.isCombination = true;
                }
        ...
        scope.isShowDashLine = (displayComponent: LeftPaletteComponent): boolean => {
            if (displayComponent.getComponentSubType() == "Combination") {
                return true
            }
            else {
