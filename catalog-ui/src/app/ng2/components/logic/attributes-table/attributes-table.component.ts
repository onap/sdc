...
export class AttributesTableComponent implements OnChanges {
  ...
  private selectedAttributeToDelete: AttributeFEModel;
  ...
  constructor(private attributesService: AttributesService, private modalService: ModalService) {
  }
  ...
  onClickAttributeRow = (attribute: AttributeFEModel, instanceName: string, event?) => {
