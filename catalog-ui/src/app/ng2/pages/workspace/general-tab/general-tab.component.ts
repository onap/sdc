...
export class GeneralTabComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.form = this.generalFormService.buildForm(this.readPatterns(), isResourceComponent);
     ...
     *  Ported from GeneralViewModel.getMetadataKeyValidValues (lines 943-953). */
    getMetadataKeyValidValues(key: string): string[] {
        const metadataKey = this.getMetadataKey(key);
        return (metadataKey && metadataKey.validValues) ? metadataKey.validValues : [];
    }
