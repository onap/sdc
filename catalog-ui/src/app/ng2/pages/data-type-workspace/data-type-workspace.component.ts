...
@Component({
  selector: 'app-data-type-workspace',
  templateUrl: './data-type-workspace.component.html',
  styleUrls: ['./data-type-workspace.component.less']
})
export class DataTypeWorkspaceComponent implements OnInit {
