...
export class ToscaGetFunctionComponent implements OnInit, OnChanges {
    ...
    private hasSameType(property: PropertyBEModel | AttributeBEModel): boolean {
        ...
        let validPropertyType = property.type === PROPERTY_TYPES.LIST ? property.schema.property.type : property.type;
        if (property.type === PROPERTY_TYPES.LIST && this.isComplexType(validPropertyType)) {
