...
export class PropertiesAssignmentComponent {
    ...
    declareProperties = (propertyType: string): void => {
        ...
        let propertiesToCreate: InstancePropertiesAPIMap = new InstancePropertiesAPIMap(selectedComponentInstancesInputs, selectedComponentInstancesOutputs, selectedComponentInstancesProperties, selectedGroupInstancesProperties, selectedPolicyInstancesProperties);
    ...
    declareListProperties = (): void => {
        ...
        let inputsToCreate: InstancePropertiesAPIMap = new InstancePropertiesAPIMap(selectedComponentInstancesInputs, null, selectedComponentInstancesProperties, selectedGroupInstancesProperties, selectedPolicyInstancesProperties);
     ...
     declarePropertiesToPolicies = (): void => {
        ...
        let policiesToCreate: InstancePropertiesAPIMap = new InstancePropertiesAPIMap(null, null, selectedComponentInstancesProperties, null, null);
        this.loadingPolicies = true;
