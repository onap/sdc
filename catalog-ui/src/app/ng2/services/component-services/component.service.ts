...
export class ComponentServiceNg2 {
    ...
    protected getCombinationDataFromServer(componentType: string, componentId: string): Observable<any> {
    ...
    getCombinationData(component: Component): Observable<any> {
        return this.getCombinationDataFromServer(component.componentType, component.uniqueId);
    }
    ...
    createServiceCombination(component: Component, serviceId: string): Observable<any> {
