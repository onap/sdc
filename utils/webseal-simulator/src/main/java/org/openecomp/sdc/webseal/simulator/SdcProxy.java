...
public class SdcProxy extends HttpServlet {
    ...
    private static final Set<String> RESERVED_HEADERS = Arrays.stream(ReservedHeaders.values())
                                                              .map(h -> h.name()).collect(Collectors.toSet());
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        Protocol https = new Protocol("https", new DummySSLProtocolSocketFactory(), 9443);
    ...
    private synchronized void proxy(HttpServletRequest request, HttpServletResponse response, MethodEnum methodEnum)
            throws IOException, UnsupportedEncodingException, HttpException {
