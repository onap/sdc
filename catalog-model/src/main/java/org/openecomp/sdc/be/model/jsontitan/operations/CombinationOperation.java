...
public class CombinationOperation {
    ...
    public Either<Combination, StorageOperationStatus> createCombinationElement
        ...
        try {
            ...
            combinationVertex = fillMetadata(combinationVertex, combination, combinationJson);
            ...
            if (status != StorageOperationStatus.OK) {
                log.debug("Failed to attach Vertex to Catalog Root");
    ...
    private GraphVertex fillMetadata
            (GraphVertex combinationVertex, Combination combination, String combinationJson) {
