...
public class ModelOperation {
    ...
    private void addDerivedFromRelation(Model model) {
        String derivedFrom = model.getDerivedFrom();
        if (derivedFrom == null) {
            return;
        }
    ...
    private Model convertToModel(final GraphVertex modelGraphVertex) {
        ...
        Either<ImmutablePair<ModelData, GraphEdge>, JanusGraphOperationStatus> parentNode =
        ...
        if (parentNode.isRight()) {
            ...
            ModelData parentModel = parentNode.left().value().getKey();
