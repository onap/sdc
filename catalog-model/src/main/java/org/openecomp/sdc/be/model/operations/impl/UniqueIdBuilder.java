...
public class UniqueIdBuilder {
     ...
     * @return
     */
    static String getKeyByNodeType(NodeTypeEnum nodeTypeEnum) {
    ...
    static String buildCapabilityTypeUid(final String modelName, String type) {
    ...
    static String buildArtifactTypeUid(final String modelName, final String name) {
