...
public class ComponentCacheTest extends ModelConfDependentTest {
    ...
    private final String mockComponentUid = "mock";
    private final long lastModificationTime = 0L;

    private final String getComponentsFullMethod = "getComponentsFull";
    ...
    public void testGetComponentNotFound() throws Exception {
        ...
        Mockito.when(componentCassandraDao.getComponent(mockComponentUid))
                .thenReturn(Either.right(ActionStatus.ARTIFACT_NOT_FOUND));
        // default test
        result = testSubject.getComponent(mockComponentUid, null, null);
    ...
    public void testGetComponentInvalidDate() throws Exception {
        ...
        Mockito.when(componentCassandraDao.getComponent(mockComponentUid)).thenReturn(Either.left(a));
        // default test
        result = testSubject.getComponent(mockComponentUid, lastModificationTime, null);
    ...
    public void testGetDataFromInMemoryCache() throws Exception {
        ...
        components.add(mockComponentUid);
    ...
    public void testGetComponentsForLeftPanel() throws Exception {
        ...
        // default test
        result = testSubject.getComponentsForLeftPanel(ComponentTypeEnum.RESOURCE, mockComponentUid,
                filteredResources);
        assertTrue(result.isLeft());
        assertTrue(result.left().value().left.isEmpty());
        assertTrue(result.left().value().middle.isEmpty());
    ...
    public void testFilterFieldsForLeftPanel() throws Exception {
        ...
        String filterFieldsForLeftPanelMethod = "filterFieldsForLeftPanel";
        ...
        result = Deencapsulation.invoke(testSubject, filterFieldsForLeftPanelMethod, resource);
        ...
        result = Deencapsulation.invoke(testSubject, filterFieldsForLeftPanelMethod, service);
    ...
    public void testFilterFieldsForCatalog() throws Exception {
        Component result;
        String filterFieldsForCatalogMethod = "filterFieldsForCatalog";

        // default test

        Resource resource = new Resource();
        resource.setComponentType(ComponentTypeEnum.RESOURCE);
        result = Deencapsulation.invoke(testSubject, filterFieldsForCatalogMethod, resource);
        assertEquals(ComponentTypeEnum.RESOURCE, result.getComponentType());
        Service service = new Service();
        service.setComponentType(ComponentTypeEnum.SERVICE);
        result = Deencapsulation.invoke(testSubject, filterFieldsForCatalogMethod, service);
        assertEquals(ComponentTypeEnum.SERVICE, result.getComponentType());
        Product product = new Product();
        product.setComponentType(ComponentTypeEnum.PRODUCT);
        result = Deencapsulation.invoke(testSubject, filterFieldsForCatalogMethod, product);
    ...
    public void testGetComponentsFullDisabled() throws Exception {
        ...
        // default test
        testSubject.setEnabled(false);
        result = Deencapsulation.invoke(testSubject, getComponentsFullMethod, Set.class);
        assertEquals(Either.right(ActionStatus.NOT_ALLOWED), result);
    }
    ...
    public void testGetComponentsFullDesirializeError() throws Exception {
        ...
        result = Deencapsulation.invoke(testSubject, getComponentsFullMethod, filteredResources);
        assertTrue(result.isLeft());
        assertTrue(result.left().value().left.isEmpty());
        assertTrue(result.left().value().middle.isEmpty());
    ...
    public void testGetComponent_1() throws Exception {
        ...
        // default test
        result = testSubject.getComponent(mockComponentUid);
        assertEquals(Either.right(ActionStatus.ARTIFACT_NOT_FOUND), result);
    }
    ...
    public void testGetComponent_2() throws Exception {
        ...
        result = testSubject.getComponent(mockComponentUid, null, filterFieldsFunc);
        assertEquals(Either.right(ActionStatus.ARTIFACT_NOT_FOUND), result);
    }
