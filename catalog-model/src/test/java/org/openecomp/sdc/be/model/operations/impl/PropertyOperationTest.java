...
public class PropertyOperationTest extends ModelTestBase {
    ...
    private static final String PROPERTY_NOT_VALID_MSG = "Property type should not be valid";
    ...
    public void testIsPropertyTypeValidForNullPropertyOrPropertyType() {
        ...
        assertFalse(PROPERTY_NOT_VALID_MSG, propertyOperation.isPropertyTypeValid(null));
        assertFalse(PROPERTY_NOT_VALID_MSG,
            propertyOperation.isPropertyTypeValid(new PropertyDefinition()));
        assertFalse(PROPERTY_NOT_VALID_MSG, propertyOperation.isPropertyTypeValid(null, null));
        assertFalse(PROPERTY_NOT_VALID_MSG,
    ...
    public void testIsPropertyTypeValidForNotFoundType() {
        ...
        assertFalse(PROPERTY_NOT_VALID_MSG, propertyOperation.isPropertyTypeValid(propertyDefinition));
        assertFalse(PROPERTY_NOT_VALID_MSG,
    ...
    public void testIsPropertyTypeValidForValidToscaType() {
        final PropertyOperation propertyOperation = createTestSubject();
        final PropertyDefinition propertyDefinition = buildPropertyDefinition();
        final String assertMsg = "Property type should be valid";
        assertTrue(assertMsg, propertyOperation.isPropertyTypeValid(propertyDefinition));
        assertTrue(assertMsg, propertyOperation.isPropertyTypeValid(propertyDefinition, null));
    }
    ...
    public void testIsPropertyTypeValidForNonToscaTypeProvidedInList() {
        ...
        final String assertMsg = "Property type should match a data type in list";
        assertTrue(assertMsg, propertyOperation.isPropertyTypeValid(propertyDefinition, dataTypeDefinitionList));
        dataTypeDefinition.setName(nonToscaType + "dummyValue");
        assertFalse(assertMsg, propertyOperation.isPropertyTypeValid(propertyDefinition, dataTypeDefinitionList));
    }
