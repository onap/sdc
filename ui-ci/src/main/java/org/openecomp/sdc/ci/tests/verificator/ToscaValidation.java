...
//				verification exclude fields as (immutable, hidden, constraints, entry_schema) according Renana  
				if(expectedValue != null && field.getName() != "name" && field.getName() != "immutable" && field.getName() != "hidden" && field.getName() != "constraints" && field.getName() != "entry_schema" && field.getName() != "required"){
					if(actualValue != null){
