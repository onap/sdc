...
public class OpsOperationPage {
    ...
    public static final int WEB_DRIVER_TIME_OUT = 90;
    public static final int MAX_WAITING_PERIOD_MS = 5 * 60 * 1000;
    public static final int NAP_PERIOD = 10000;
    public static final int MAX_WAITING_PERIOF_DIVIDER = 1000;
