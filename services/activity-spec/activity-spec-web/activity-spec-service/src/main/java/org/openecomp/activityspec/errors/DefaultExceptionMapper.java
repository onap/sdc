...
public class DefaultExceptionMapper implements ExceptionMapper<Exception> {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(org.openecomp.sdcrests
      .errors.DefaultExceptionMapper.class);
  ...
  private Response transform(CoreException coreException) {
    ...
    return Response
        ...
        .entity(new ActivitySpecErrorResponse(Status.EXPECTATION_FAILED, coreException.code().id(),
  ...
  private Response transform(ConstraintViolationException validationException) {
    ...
    return Response
        .status(Status.EXPECTATION_FAILED)
        .entity(new ActivitySpecErrorResponse(Status.EXPECTATION_FAILED,
  ...
  private Response transform(Exception exception) {
    ...
    return Response
        ...
        .entity(new ActivitySpecErrorResponse(Status.EXPECTATION_FAILED,"GENERAL_ERROR_REST_ID",
  ...
  private Response transform(JsonMappingException jsonMappingException) {
    ...
    return Response
        .status(Status.EXPECTATION_FAILED)
        .entity(new ActivitySpecErrorResponse(Status.EXPECTATION_FAILED,"JSON_MAPPING_ERROR_ERR_ID",
            "Invalid Json Input"))
        .type(MediaType.APPLICATION_JSON)
        .build();
  }
