...
public class PropertyDefinitionUtilsTest {
    ...
    public void testConvertListOfProperties() {
        ...
        List<PropertyDataDefinition> propertyDataDefinitions = PropertyDefinitionUtils.convertListOfProperties(inputDataDefinitions);
    ...
    public void testResolveGetInputPropertiesForEmptyMap() {
        Map<String, List<PropertyDataDefinition>> inputProps = PropertyDefinitionUtils.resolveGetInputProperties(null);
