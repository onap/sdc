...
public class RequirementDataDefinition extends ToscaDataDefinition {
    ...
    private static final String MIN_OCCURRENCES = "0";
    private static final String MAX_OCCURRENCES = "UNBOUNDED";
    private static final String MAX_DEFAULT_OCCURRENCES = "1";
