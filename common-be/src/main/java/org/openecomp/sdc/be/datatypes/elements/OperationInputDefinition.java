...
public class OperationInputDefinition extends PropertyDataDefinition {
    ...
    public OperationInputDefinition(String name, PropertyDataDefinition inputDefinition) {
