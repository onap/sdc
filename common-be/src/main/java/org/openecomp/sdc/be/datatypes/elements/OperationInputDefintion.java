...
public class OperationInputDefintion extends PropertyDataDefinition {

    @JsonCreator
    public OperationInputDefintion() {
        super();
    }

    public OperationInputDefintion(String name, PropertyDataDefinition inputDefinition) {
