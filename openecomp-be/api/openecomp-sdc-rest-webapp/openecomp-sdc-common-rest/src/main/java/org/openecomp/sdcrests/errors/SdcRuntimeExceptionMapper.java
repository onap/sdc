...
public class SdcRuntimeExceptionMapper implements ExceptionMapper<SdcRuntimeException> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SdcRuntimeExceptionMapper.class);
