...
public class TogglzFeatureImpl implements ITogglzFeature {

    public TogglzFeatureImpl() {
    }

    @Override
    public Response getFeatures() {
        List<ToggleableFeature> toggleableFeatures = Arrays.asList(ToggleableFeature.values());
        ...
        mapToggleableFeatureToDto.doMapping(toggleableFeatures, featureSetDto);
