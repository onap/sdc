...
public class ApiTests {
  ...
  public void testApi() throws Exception {
    ...
    Response r = testing.getConfig();
    Response r2 = testing.getTestDefinition("bogus");
    Response r3 = testing.getTestDefinition("ep", "bogus");

    TestExecutionRequest req = new TestExecutionRequest();
    Response r4 = testing.run(req);

    Response r5 = testing.listTests();
    ...
    Response r5F = testingF.listTests();
    Response rF = testingF.getConfig();
    Response r2F = testingF.getTestDefinition("bogus");
    Response r3F = testingF.getTestDefinition("ep", "bogus");

    TestExecutionRequest reqF = new TestExecutionRequest();
    Response r4F = testingF.run(req);
