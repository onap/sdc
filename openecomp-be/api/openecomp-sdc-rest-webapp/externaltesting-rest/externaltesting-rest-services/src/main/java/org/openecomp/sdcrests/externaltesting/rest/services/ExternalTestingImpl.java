...
public class ExternalTestingImpl implements ExternalTesting {
    ...
    @Override
    public Response execute(String vspId, String vspVersionId, List<Attachment> files, String testDataString, String userId) {
        try {
            ...
            testingManager.updateVtpResultInDB(req, vspId, vspVersionId, requestId,userId );
    ...
    @Override
    public Response getValidationResult(String vspId, String vspVersion, String userId) {
        try {
            List<VtpResultsEntity> vtpResultsEntities = vendorSoftwareProductManager.getVtpResultId(vspId, vspVersion, userId);
