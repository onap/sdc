...
public class CatalogVspClientImpl implements CatalogVspClient {
    ...
    public Optional<String> findNameOfVfUsingVsp(String vspId, String user) throws CatalogRestClientException {
        ...
        try {
            return getVspNameUsedInVf(httpResponse, mapper);
        } catch (Exception e) {
    ...
    @NotNull
    private Optional<String> getVspNameUsedInVf(HttpResponse<String> httpResponse, ObjectMapper mapper) throws JsonProcessingException {
