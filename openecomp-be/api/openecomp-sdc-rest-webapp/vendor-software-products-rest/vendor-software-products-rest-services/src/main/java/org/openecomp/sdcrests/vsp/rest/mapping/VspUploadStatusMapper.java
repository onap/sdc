...
public class VspUploadStatusMapper extends MappingBase<VspUploadStatus, VspUploadStatusDto> {

    @Override
    public void doMapping(final VspUploadStatus source, final VspUploadStatusDto target) {
