...
public class VendorSoftwareProductsImpl implements VendorSoftwareProducts {
    ...
    public static final String VALIDATION_VSP_USER = "validationOnlyVspUser";
    ...
    private ItemCreationDto retrieveValidationVsp() {
        ...
        synchronized (VALIDATION_VSP_CACHE_LOCK) {
            ...
            try {
            ...
            } catch (CoreException vspAlreadyCreatedBySomeoneElse) {
                LOGGER.debug("VSP already created", vspAlreadyCreatedBySomeoneElse);
                ...
                String validationVspId = itemManager.list(validationVspFilter).stream().findFirst()
                        .orElseThrow(() -> new IllegalStateException(
                                "Vsp with name %s does not exist even though the name "
                                        + "exists according to unique value util"))
                        .getId();
