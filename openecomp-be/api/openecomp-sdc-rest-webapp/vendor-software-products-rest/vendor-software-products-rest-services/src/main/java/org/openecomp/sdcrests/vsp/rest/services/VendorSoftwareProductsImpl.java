...
public class VendorSoftwareProductsImpl implements VendorSoftwareProducts {
    ...
    private final SdcBeRestCall sdcBeRestCall;
    ...
    public VendorSoftwareProductsImpl() {
        ...
        this.sdcBeRestCall = new SdcBeRestCallImpl();
    }
    ...
    public VendorSoftwareProductsImpl(AsdcItemManager itemManager,
        ...
        this.sdcBeRestCall = sdcBeRestCall;
    }
    ...
    public Response deleteVsp(String vspId, String user) {
        ...
        try {
            Optional<String> optUsedInVf = sdcBeRestCall.getNameOfVfUsingVsp(vspId, user);
        ...
        if (Objects.isNull(certifiedVersionsCounter) || certifiedVersionsCounter == 0) {
            ...
            final var match = getVspList(null, ItemStatus.ARCHIVED.name(), user).stream().anyMatch(item -> item.getId().equals(vspId));
            if (match) {
                return getResponseDeletionOk(vspId, user, vsp);
            }
