...
public class VendorSoftwareProductsImpl implements VendorSoftwareProducts {
  ...
  public Response createVsp(VspRequestDto vspRequestDto, String user) {
    ...
    switch (onboardingMethod) {
      ...
      case Manual:
        ...
        itemCreationDto = getManualItemCreationDto(vspRequestDto, user, onboardingMethod, item);
        break;
      default:
        throw getUnknownOnboardingMethod();
    }
  ...
  private ItemCreationDto getManualItemCreationDto(VspRequestDto vspRequestDto,
                                                   String user,
                                                   OnboardingMethod onboardingMethod,
                                                   Item item) {
    ItemCreationDto itemCreationDto;
  ...
  public Response actOnVendorSoftwareProduct(VersionSoftwareProductActionRequestDto request,
    ...
    switch (request.getAction()) {
      case Submit:
        Response validationResponseDto = getSubmitResponse(request, vspId, user, version);
  ...
  private Response getSubmitResponse(VersionSoftwareProductActionRequestDto request,
