...
class VspUploadStatusMapperTest {

    @Test
    void fullMappingTest() {
        //given
        final VspUploadStatusMapper vspUploadStatusMapper = new VspUploadStatusMapper();
        final var vspUploadStatus = new VspUploadStatus();
        ...
        //when
        vspUploadStatusMapper.doMapping(vspUploadStatus, vspUploadStatusDto);
        //then
