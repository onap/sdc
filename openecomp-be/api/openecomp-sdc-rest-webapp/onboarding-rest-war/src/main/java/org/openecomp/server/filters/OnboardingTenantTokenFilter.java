...
import org.openecomp.sdc.common.tenant.MultitenancyConfigLoader;
import org.openecomp.sdc.common.tenant.TenantTokenFilter;

public class OnboardingTenantTokenFilter extends TenantTokenFilter {

    @Override
    protected MultitenancyConfig loadConfig() {
        return MultitenancyConfigLoader.fromConfigurationFileProperty();
    }
}
