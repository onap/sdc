...
public class MapLicenseAgreementDescriptorDtoToLicenseAgreementEntityTest {
	...
	public void testName() throws Exception {
		...
		MapLicenseAgreementDescriptorDtoToLicenseAgreementEntity mapper = new MapLicenseAgreementDescriptorDtoToLicenseAgreementEntity();
	...
	@Test
	public void testRequirementsAndConstrains() throws Exception {
		LicenseAgreementDescriptorDto source = new LicenseAgreementDescriptorDto();
		LicenseAgreementEntity target = new LicenseAgreementEntity();
		MapLicenseAgreementDescriptorDtoToLicenseAgreementEntity mapper = new MapLicenseAgreementDescriptorDtoToLicenseAgreementEntity();
		mapper.doMapping(source, target);
		assertEquals(target.getRequirementsAndConstrains(), source.getRequirementsAndConstrains());
		String param = "be6df4d3-b534-4c62-b611-4ed5b67e72ab";
		source.setRequirementsAndConstrains(param);
		mapper.doMapping(source, target);
		assertNotNull(source.getRequirementsAndConstrains());
		assertNotNull(target.getRequirementsAndConstrains());
		assertEquals(target.getRequirementsAndConstrains(), param);
	}

	@Test
	public void testLicenseTerm() throws Exception {
		LicenseAgreementDescriptorDto source = new LicenseAgreementDescriptorDto();
		LicenseAgreementEntity target = new LicenseAgreementEntity();
		MapLicenseAgreementDescriptorDtoToLicenseAgreementEntity mapper = new MapLicenseAgreementDescriptorDtoToLicenseAgreementEntity();
		...
		mapper.doMapping(source, target);
		assertNotNull(source.getLicenseTerm());
		assertNotNull(target.getLicenseTerm());
