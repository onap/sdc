...
public class CatalogNotifier {
...

   {
    ...
    private void handleHttpRequest(String url, Collection<String> itemIds, ItemAction action, String userId) {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 500) {
                ...
                Map jsonBody = JsonUtil.json2Object(response.getEntity().getContent(), Map.class);
                HttpPost requestRetry = createPostRequest(url, jsonBody.get("failedIds").toString() , userId);
    ...
    private HttpPost createPostRequest(String postUrl, String itemIds, String userId) throws UnsupportedEncodingException {
