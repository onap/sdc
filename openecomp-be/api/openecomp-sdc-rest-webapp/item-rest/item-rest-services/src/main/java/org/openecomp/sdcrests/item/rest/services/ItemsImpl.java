...
public class ItemsImpl implements Items {
    ...
    public Response list(String itemStatusFilter, String versionStatusFilter,
        ...
        GenericCollectionWrapper<ItemDto> results = new GenericCollectionWrapper<>(items.stream()
    ...
    private class ActionSideAffects {
        ...
        private void execute(Item item, String user) {
            notifyUsers(item.getId(), item.getName(), user,
        ...
        private void notifyUsers(String itemId, String itemName,
    ...
    private Predicate<Item> createVersionStatusPredicate(String filterValue) {
        Set<VersionStatus> versionStatuses =  Arrays.stream(filterValue.split(","))
                .map(VersionStatus:: valueOf).collect(Collectors.toSet());
    ...
    private Predicate<Item> createOnboardingMethodPredicate(String filterValue) {
        return item -> !item.getType().equals(ItemType.vsp.name()) ||
                item.getType().equals(ItemType.vsp.name()) &&
