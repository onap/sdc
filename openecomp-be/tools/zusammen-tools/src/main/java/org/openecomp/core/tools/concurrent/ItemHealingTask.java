  ...
  public String call() throws Exception {
    ...
    try {
      ...
      return ("healing failed on vsp: " + vspDetails.getName() + "with id: " + itemId + " " +
          ", versionId" + versionId + ", resolved Version:" + resolvedVersion + ", time: " +
          System.currentTimeMillis() + ", with message: " + e.getMessage());
    }

    return "healed vsp: " + vspDetails.getName() + " with id: " + itemId
        + ", versionId: " + versionId + ", resolved version: " +
        resolvedVersion + ", time: " + System.currentTimeMillis();
  }
