...
public class NotificationHandler {
  ...
  private static NotificationAccessor accessor =
      noSqlDb.getMappingManager().createAccessor(NotificationAccessor.class);

  public void registerNotificationForUserOnEntity(String user, String entityId) {

    Set<String> userSet = new HashSet<>();
    userSet.add(user);
    accessor.updateNotificationSubscription(userSet, entityId);
  }
