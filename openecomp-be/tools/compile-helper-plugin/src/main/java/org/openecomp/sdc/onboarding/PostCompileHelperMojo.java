...
public class PostCompileHelperMojo extends AbstractMojo {
    ...
    private File[] getCompiledClasses(File compiledFiles) {
        ...
        //File[] list = FileUtils.listFiles(compiledFiles, new String[] {"class"}, true).toArray(new File[0]);
        File[] list = null;
        try {
        ...
        //Arrays.sort(list, (file1, file2) -> Long.compare(file1.lastModified(), file2.lastModified()));
        return list;
    }
