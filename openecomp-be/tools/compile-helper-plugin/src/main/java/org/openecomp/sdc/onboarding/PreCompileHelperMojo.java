...
public class PreCompileHelperMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        setArtifactPath(mainToBeCompiled, instrumented, JAR.equals(project.getPackaging()), resourceMainBuildDataSameWithPreviousBuild);
    }
    ...
    private void setArtifactPath(boolean mainToBeCompiled, boolean instrumented, boolean isJar, boolean resourceDataSame){
        if (!mainToBeCompiled && !instrumented && isJar
                    && resourceDataSame) {
