...
public class ElementToEntitlementPoolConvertorTest {
    ...
    private ElementToEntitlementPoolConvertor converter = new ElementToEntitlementPoolConvertor();
    ...
    public void shouldConvertElementToEntitlementPoolEntity() {
        ...
        EntitlementPoolEntity result = converter.convert(elementToConvert);
