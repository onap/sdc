...
public class ElementToLicenseAgreementConvertorTest {
    ...
    private static final String LICENSE_TERM = "Fixed_Term";

    private ElementToLicenseAgreementConvertor converter = new ElementToLicenseAgreementConvertor();

    @Test
    public void shouldConvertElementToLicenseAgreementEntity() {
        ...
        LicenseAgreementEntity result = converter.convert(elementToConvert);
        ...
        assertEquals(LICENSE_TERM, result.getLicenseTerm().getChoice().name());
    }

    @Test
    public void shouldConvertElementInfoToLicenseAgreementEntity(){
    ...
    private Info createInfo(){
        ...
        HashMap<String,String> choiceOrOther = new HashMap<>();
        choiceOrOther.put("choice", LICENSE_TERM);
        choiceOrOther.put("other", "other");
        info.addProperty("licenseTerm", choiceOrOther);
        return info;
    }
}
