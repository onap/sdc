...
public class NetworkPackageHealerTest {
    ...
    public void shouldHeal() throws Exception {
        ...
        Mockito.when(element.getData()).thenReturn(IOUtils.toInputStream("ANY", "UTF-8"));
        Mockito.when(subElement2.getData()).thenReturn(IOUtils.toInputStream("ANY", "UTF-8"));
