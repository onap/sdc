...
public class NetworkPackageHealer implements Healer {
  ...
  public void heal(String itemId, Version version) throws Exception {
    ...
    Id candidateValidationElementId = getCandidateValidationElementId(candidateSubs, context,
    ...
    Id structureElementId = getStructureElementId(orchestrationTemplateSubs, context,
  ...
  private Id getStructureElementId(Collection<Element> orchestrationTemplateSubs,
  ...
  private Id getCandidateValidationElementId(Collection<Element> candidateSubs,
