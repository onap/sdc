...
public class PortMirroringEnricherTest extends BaseToscaEnrichmentTest {
  ...
  @BeforeClass
  public void enablePortMirroringFeature(){
    manager = new TestFeatureManager(ToggleableFeature.class);
    if (!ToggleableFeature.PORT_MIRRORING.isActive()) {
      manager.enable(ToggleableFeature.PORT_MIRRORING);
    }
  }
  ...
  @AfterClass
  public void disablePortMirroringFeature() {
    manager.disable(ToggleableFeature.PORT_MIRRORING);
    manager = null;
