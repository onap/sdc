...
public class MonitoringMibEnricher implements ExternalArtifactEnricherInterface {
  ...
  Map<String, List<ErrorMessage>> enrichComponent(String vspId,
    ...
    List<ComponentMonitoringUploadInfo> componentMonitoringUploadInfoList =
        extractComponentMibInfo(vspId, version, componentEntry, abstractNodeTypes, errors);
    enrichComponentMib(componentMonitoringUploadInfoList, vspId, version, errors);
  ...
  private List<ComponentMonitoringUploadInfo> extractComponentMibInfo(String vspId, Version version,
    ...
    for (String unifiedComponentNodeType : abstractNodeTypes) {
      Optional<ComponentMonitoringUploadInfo> componentMonitoringUploadInfo =
          updComponentMibInfoByType(unifiedComponentNodeType,
              entity);
      componentMonitoringUploadInfo.ifPresent(componentMonitoringUploadInfoList::add);
    }
  ...
  private Optional<ComponentMonitoringUploadInfo> updComponentMibInfoByType(String componentName,
    ...
    for (MonitoringUploadType type : MonitoringUploadType.values()) {
      ...
      path = getArtifactPath(type, componentName);
      updateComponentMonitoringUploadInfoWithMib(path, type, mibArtifact,
          componentMonitoringUploadInfo);
    }

    mdcDataDebugMessage.debugExitMessage(null);
    return Optional.of(componentMonitoringUploadInfo);
  }
  ...
  private void enrichComponentMib(
      List<ComponentMonitoringUploadInfo> componentMonitoringUploadInfoList,
      String vspId,
      Version version,
      Map<String, List<ErrorMessage>> errors) {
    ...
    for (ComponentMonitoringUploadInfo componentUploadInfo : componentMonitoringUploadInfoList) {
