...
public class CommonUtilTest {
    ...
    private static final String VALID_CSAR_FILE_PATH = "src/test/resources/valid.zip";
    private static final String VALID_ZIP_WITH_DIR_FILE_PATH = "src/test/resources/zip_with_dir.zip";
