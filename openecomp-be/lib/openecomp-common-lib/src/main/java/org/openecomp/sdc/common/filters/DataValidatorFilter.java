...
import static org.openecomp.sdc.common.exception.DataValidatorFilterExceptionSupplier.notAllowedSpecialCharsError;
...
public class DataValidatorFilter extends DataValidatorFilterAbstract {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response, final FilterChain chain)
        ...
        try {
            ...
            throw notAllowedSpecialCharsError().get();
        }
    }
