...
public class CommonConfigurationManager {
    ...
    private static final Logger LOGGER = Logger.getLogger(CommonConfigurationManager.class.getName());
    private static CommonConfigurationManager singletonInstance;
    private static Map<String, LinkedHashMap<String, Object>> configuration;
