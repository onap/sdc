...
public enum Messages {
    ...
    VSP_VERSION_NOT_FOUND("Vendor Software Product with id '%s' and version id '%s' not found."),
    DELETE_CERTIFIED_VSP_ERROR("The VSP '%s' has been certified and cannot be deleted."),
