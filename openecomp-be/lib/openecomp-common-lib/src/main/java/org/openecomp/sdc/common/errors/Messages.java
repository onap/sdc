...
public enum Messages {
    ...
    MANIFEST_EXPECTED_ALGORITHM_BEFORE_HASH("Expected 'Algorithm' entry before 'Hash' entry"),MANIFEST_DUPLICATED_CMS_SIGNATURE("Duplicated CMS signature"),
    ...
    INCORRECT_SW_INFORMATION_NON_MANO_ERROR(
        "Incorrect software information non-mano artifact. The software version information is missing or it "
            + "has one or more incorrect software version entries: '%s'"),
