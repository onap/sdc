...
public class PermissionsFilterTest {
    ...
    public void testGetPermissioinServices() {
        permissionsFilter.getPermissionsServices();
    }
    ...
    private void initializeMocking(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
        ...
        Mockito.doReturn(permissionsServicesMock).when(permissionsFilter).getPermissionsServices();
