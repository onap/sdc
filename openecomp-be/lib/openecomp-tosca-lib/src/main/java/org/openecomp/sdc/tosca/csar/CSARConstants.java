...
import static org.openecomp.sdc.tosca.csar.ManifestTokenType.REALEASE_DATE_TIME;
...
public class CSARConstants {
    ...
    public static final ImmutableSet<String> MANIFEST_ASD_METADATA = of(ENTRY_DEFINITION_TYPE.getToken(), REALEASE_DATE_TIME.getToken());
