...
public class ManifestUtils {
    ...
    public <T extends AbstractOnboardingManifest> Manifest loadManifest(final FileContentHandler handler, final T abstractManifest) throws IOException {
    ...
    public <T extends AbstractOnboardingManifest> Manifest getManifest(FileContentHandler handler, T manifest) throws IOException {
        ToscaMetadata metadata = getMetadata(handler);
        return getManifest(handler, getEntryManifestLocation(metadata), manifest);
    }

    public ToscaMetadata getMetadata(FileContentHandler handler) throws IOException {
    ...
    public <T extends AbstractOnboardingManifest> Manifest getManifest(FileContentHandler handler, String manifestLocation, T manifest) throws IOException {
