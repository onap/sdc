...
public class ActionDaoImpl implements ActionDao {
    ...
    // mapper-based DAO (generated at compile time)
    ...
    public ActionDaoImpl() {
        // no-op; static initializers used above
    }

    @Override
    public void registerVersioning(String versionableEntityType) {
        // NOTE: in 3.x you used mapper metadata; here we provide the table and PK names explicitly.
    ...
    public Action updateAction(Action action) {
        try {
            ...
            accessor.addAction(action.toEntity()); // upsert semantics
            ActionUtil.actionLogPostProcessor(COMPLETE, null, "", false);
            log.metrics("");
    ...
    public void deleteAction(String actionInvariantUuId) {
        try {
            ...
            // build query to get name for specific active version
   ...
   @Override
    ...
    private void logGenericException(Exception exception) {
     ...
     private void updateActionStatusForDelete(String actionInvariantUuId, List<Version> versions) {
        ...
        // Use SimpleStatement for update
