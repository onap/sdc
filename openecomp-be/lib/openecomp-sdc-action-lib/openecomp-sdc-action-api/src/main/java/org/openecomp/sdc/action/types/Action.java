...
public class Action implements Comparable {
  ...
  public ActionEntity toEntity() {
    ...
    destination.setVendorList(this.getVendorList().stream().collect(Collectors.toSet()));
    destination.setCategoryList(this.getCategoryList().stream().collect(Collectors.toSet()));
  ...
  private Set<String> getIdFromMap(List<HashMap<String, String>> map, String idName) {
