...
public class FileUtilsTest {
    ...
    @Test
    public void testDeleteFilesAndFolders() throws IOException {
        String pathName = FileUtilsTest.class.getPackage().getName().replace('.', '/') +
            "/TestDir";
        File file = new File(pathName, "TestFile.txt");
        file.getParentFile().mkdirs();
        file.createNewFile();
        FileUtils.deleteFilesAndFolders(pathName);
    ...
    public void testIsValidYamlExtension() throws IOException {
        ...
        assertTrue(FileUtils.isValidYamlExtension("zip"));
    }
}