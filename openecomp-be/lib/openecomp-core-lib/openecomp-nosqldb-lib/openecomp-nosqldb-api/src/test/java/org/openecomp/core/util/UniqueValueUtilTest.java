...
public class UniqueValueUtilTest {
    ...
    public void testCreateUniqueValue() {
        ...
        uniqueValueUtil.createUniqueValue("Entitlement Pool name", "originalEntityName");
    ...
    public void testDeleteUniqueValue() {
        ...
        uniqueValueUtil.deleteUniqueValue("Entitlement Pool name", "originalEntityName");
    ...
    public void testDeleteUniqueValueNoValue() {
        uniqueValueUtil.deleteUniqueValue("Entitlement Pool name");
    ...
    public void testUpdateUniqueValue() {
        ...
        uniqueValueUtil.updateUniqueValue("Entitlement Pool name", "oldValue", "newValue", "uniqueContext");
    ...
    public void testValidateUniqueValue() {
        Mockito.when(uniqueValueDao.get(Mockito.any())).thenReturn(null);
        uniqueValueUtil.validateUniqueValue("Entitlement Pool name", "originalEntityName");
    ...
    public void testIsUniqueValueOccupied() {
        Mockito.when(uniqueValueDao.get(Mockito.any())).thenReturn(new UniqueValueEntity());
        Assert.assertTrue(uniqueValueUtil.isUniqueValueOccupied("Entitlement Pool name", "originalEntityName"));
    }

    @Test
    public void testIsUniqueValueOccupiedFalse() {
        Mockito.when(uniqueValueDao.get(Mockito.any())).thenReturn(null);
        Assert.assertFalse(uniqueValueUtil.isUniqueValueOccupied("Entitlement Pool name", "originalEntityName"));
    }
}
