...
public class UniqueValueUtil {
  ...
  public void createUniqueValue(String type, String... uniqueCombination) {
    ...
    if (formattedValue.isPresent()) {
      validateUniqueValue(type, formattedValue.get(), originalEntityName, uniqueCombination);
  ...
  private void validateUniqueValue(String type, String formattedValue, String originalEnityName,
    ...
    if (isUniqueValueOccupied(type, formattedValue)) {
      throw new CoreException(new ErrorCode.ErrorCodeBuilder()
          ...
          .withMessage(String
              .format(UNIQUE_VALUE_VIOLATION_MSG, type, originalEnityName))
          .build());
    }
  }
