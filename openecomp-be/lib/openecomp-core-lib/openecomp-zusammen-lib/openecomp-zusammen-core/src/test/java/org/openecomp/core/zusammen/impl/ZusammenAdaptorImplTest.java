...
public class ZusammenAdaptorImplTest {
    ...
    @Test
    public void getElementByNonExistingName() {
    ...
    @Test
    public void listElementsByNonExistingName() {
        doReturn(ELEMENTS).when(connector).listElements(CONTEXT, ELEMENT_CONTEXT, ELEMENT_ID);
    ...
    @Test
    public void listElementsByName() {
        doReturn(ELEMENTS).when(connector).listElements(CONTEXT, ELEMENT_CONTEXT, ELEMENT_ID);
    ...
    @Test
    public void getElementInfoByNonExistingName() {
        doReturn(ELEMENTS).when(connector).listElements(CONTEXT, ELEMENT_CONTEXT, ELEMENT_ID);
    ...
    @Test
    public void getElementInfoByName() {
        doReturn(ELEMENTS).when(connector).listElements(CONTEXT, ELEMENT_CONTEXT, ELEMENT_ID);
    ...
    public void saveElementWithoutIdNameOrAction() {
    ...
    @Test
    public void createRootElementTree() {
    ...
    @Test
    public void createElementByParentId() {
    ...
    @Test
    public void updateRootElementByName() {
        String message = "Update element";
        ZusammenElement element = new ZusammenElement();
        element.setAction(Action.UPDATE);
    ...
    @Test
    public void createNonExistingElementInsteadOfUpdate() {
        String message = "Create new element";
        ZusammenElement element = new ZusammenElement();
        element.setAction(Action.IGNORE);
        element.setElementId(ELEMENT_ID);
    ...
    @Test
    public void updateElementByNameAndParentId() {
    ...
    @Test
    public void ignoreExistingElementSavedWithoutAction() {
