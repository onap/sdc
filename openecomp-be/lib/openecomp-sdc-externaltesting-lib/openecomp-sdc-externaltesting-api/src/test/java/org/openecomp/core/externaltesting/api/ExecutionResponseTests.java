...
public class ExecutionResponseTests {
  ...
  public void testResponse() throws Exception {
    ...
    Assert.assertEquals("Status is Completed", "Completed", rsp.getStatus());
    ...
    Assert.assertEquals("Result item status", "Success", firstResult.getStatus());
    Assert.assertNotNull("Result item details", firstResult.getDetails());
  }

  public void sonarFail() {
    try {
      try {
        try {
          try {
