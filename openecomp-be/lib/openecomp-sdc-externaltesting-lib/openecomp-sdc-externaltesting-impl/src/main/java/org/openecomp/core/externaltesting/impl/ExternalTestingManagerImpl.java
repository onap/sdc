...
public class ExternalTestingManagerImpl implements ExternalTestingManager {
    ...
    private void processManifestItem(FileData item, ZipOutputStream zipOutput, Map<String, byte[]> contentMap)
            throws IOException {
     ...
     */
    private void processCsarArchiveEntry(String filename, ZipOutputStream zipOutput, Map<String, byte[]> contentMap)
            throws IOException {
        ...
        if (filename.endsWith(".yaml") || filename.endsWith(".yml")) {
            Yaml yaml = new Yaml();
            @SuppressWarnings("unchecked") Map<String, Object> yamlContent =
                    (Map<String, Object>) yaml.load(new ByteArrayInputStream(content));
