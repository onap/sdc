...
public interface ETSIService {
    ...
    /**
     * Checks if the package has ASD metadata.
     *
     * @param fileContentHandler the CSAR file handler
     * @return {@code true} if the package is a ASD package, {@code false} otherwise.
     * @throws IOException when it was not able to parse the TOSCA.meta file
     */
    boolean hasAsdMetadata(final FileContentHandler fileContentHandler) throws IOException;
