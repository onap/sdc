...
class PackageUploadManagerDaoImlTest {

    @Mock
    private PackageUploadManagerAccessor accessor;

    private PackageUploadManagerDaoIml packageUploadManagerDaoIml;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.openMocks(this);
        packageUploadManagerDaoIml = new PackageUploadManagerDaoIml(accessor);
    }

    @Test
    void findAllByVspIdAndVersionId() {
        //given
