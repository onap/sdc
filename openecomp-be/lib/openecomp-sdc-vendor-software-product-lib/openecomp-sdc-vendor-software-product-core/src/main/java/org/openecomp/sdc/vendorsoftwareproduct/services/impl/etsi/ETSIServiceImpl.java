...
public class ETSIServiceImpl implements ETSIService {
    ...
    private boolean hasEtsiSol261Metadata(final FileContentHandler fileContentHandler) throws IOException {
        return isSol004WithToscaMetaDirectory(fileContentHandler);
    }
