...
public class TxtInformationArtifactConstants {
    ...
    public static final String LICENSE_MODEL_VERSION = "i." + TAB + "License Model Version" + DELIMITER;
    public static final String LICENSE_AGREEMENT_NAME = "ii." + TAB + "License Agreement Name" + DELIMITER;
    ...
    public static final String USING_AVAILABILITY_ZONES = "i." + TAB + "Using Availability " + "Zones" + DELIMITER;
    public static final String STORAGE_BACKUP_DETAILS = "h." + TAB + "Storage Data Back-up " + "Details" + DELIMITER;
    public static final String IS_DATA_REPLICATION = "i." + TAB + "Data Replication Required?" + DELIMITER;
    public static final String DATA_SIZE_TO_REP = "ii." + TAB + "	Data Size to replicate in GB" + DELIMITER;
    public static final String DATA_REP_FREQUENCY = "iii." + TAB + "Data replication frequency" + DELIMITER;
    ...
    public static final String VFC_COMPUTE_CPU_OVER_SUBSCRIPTION = "2." + TAB + "CPU " + "over-subscription" + DELIMITER;
