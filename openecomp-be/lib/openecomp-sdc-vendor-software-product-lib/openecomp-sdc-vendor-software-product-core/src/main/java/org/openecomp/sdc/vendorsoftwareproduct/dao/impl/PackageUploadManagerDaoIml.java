...
public class PackageUploadManagerDaoIml implements PackageUploadManagerDao {

    private final Mapper<VspUploadStatus> mapper;
    private final PackageUploadManagerAccessor accessor;

    public PackageUploadManagerDaoIml() {
    ...
    //for tests purpose
    PackageUploadManagerDaoIml(final PackageUploadManagerAccessor accessor) {
