...
public abstract class AbstractPnfdBlockParser implements PnfdBlockParser {
    ...
    protected void parse(final Map<String, Object> blockYamlObject) {
        ...
        conversionDefinitionList.forEach(conversionDefinition -> {
            final ConversionQuery conversionQuery = conversionDefinition.getConversionQuery();
            final Object queryObj = conversionQuery.getQuery();
            if (!(queryObj instanceof Map)) {
                return;
            }

            final Map<String, Object> query = (Map<String, Object>) conversionQuery.getQuery();
            final Map<String, Object> blockAttributeMap = (Map<String, Object>) blockYamlObject
                .get(blockName);
     ...
     * @return
     *  the rebuilt original YAML object with the converted attribute
     */
     ...
     * @return
     *  the new YAML object representing the merge result.
     */
     ...
     * @return
     * {@code true} if the YAML object is a TOSCA get_input call, {@code false} otherwise
     */
    ...
    /**
     * Gets the value (input name) of a YAML object representing a TOSCA get_input call.
     * get_input: <i>value</i>
     * @param yamlObject    the YAML object
     * @return
     *  The get_input function value, that represents the input name
     */
    ...
    /**
     * Gets the stored input names called with get input and its transformation configured in {{@link #transformation get} }
     * @return
     */
