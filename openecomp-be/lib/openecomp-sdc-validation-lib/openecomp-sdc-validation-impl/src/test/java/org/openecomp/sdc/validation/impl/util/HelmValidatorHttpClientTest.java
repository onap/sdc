...
public class HelmValidatorHttpClientTest {
    ...
    public void shouldSendPostToValidatorUrl(String validatorUrl) throws Exception {
    ...
    public void shouldPrepareRequestWithDesiredVersion(String desiredVersion) throws Exception {
        //given
    ...
    @Test
    public void shouldPrepareLintableRequest() throws Exception {
        //given
        Path chartPath = getTestPath(TEST_CHART_FILE_NAME, "");
    ...
    @Test
    public void shouldPrepareStrictLintableRequest() throws Exception {
        //given
        Path chartPath = getTestPath(TEST_CHART_FILE_NAME, "");
