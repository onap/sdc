...
public class VirtualMachineInterfaceGuidelineValidatorTest {
  ...
  public void modeledThroughResourceGroupNegativeTwoValuesInList() {
    ...
    Assert.assertEquals(
        ...
        "ERROR: [VlAN_G1]: VLAN Resource will not be translated as the VLAN Sub-interface [template_vmi_Vlan_2] is not modeled as resource group");
  }
  ...
  public void vlanAloneInFileNegative_2vlans() {
    ...
    Assert.assertEquals(
        messages.get("nested.yml").getErrorMessageList().get(0).getMessage(),
        "ERROR: [VlAN_G2]: There should not be any Compute Server Node, Port, " +
  ...
  public void namingConventionNegative(){
    ...
    Assert.assertEquals(
        ...
        "WARNING: [VlAN_G3]: Network role associated with VLAN Sub-interface " +
