...
public class ContrailServiceInstanceNamingConventionValidatorTest {
  ...
  public void testContrailServiceInstanceAvailabilityZoneNotAlignedWithNamingConvention() {
    ...
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
        "WARNING: [H-1] : Service Instance 'Availability Zone' Parameter Name not aligned with Guidelines, Parameter Name [availability_zone_1a], Resource ID [service_instance_1]. As a result, VF/VFC Profile may miss this information");
  }
