...
public class NovaServerNamingConventionGuideLineValidatorTest {
  ...
  public void testHeatNovaServerVnfIDValidation() {
    Map<String, MessageContainer> messages = ValidationTestUtil.testValidator(baseValidator,
            resourceValidator, HeatResourcesTypes.NOVA_SERVER_RESOURCE_TYPE.getHeatResource(),
            "/org/openecomp/validation/validators/guideLineValidator/heatNovaServerMetaDataValidation/negativemissingvnfid/");
    Assert.assertNotNull(messages);
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().size(), 1);
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
  ...
  public void testHeatNovaServerVfModuleValidation() {
    Map<String, MessageContainer> messages = ValidationTestUtil.testValidator(baseValidator,
            resourceValidator, HeatResourcesTypes.NOVA_SERVER_RESOURCE_TYPE.getHeatResource(),
            "/org/openecomp/validation/validators/guideLineValidator/heatNovaServerMetaDataValidation/negativemisningvfmodule/");
    Assert.assertNotNull(messages);
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
  ...
  public void testMissingParam() {
    Map<String, MessageContainer> messages = ValidationTestUtil.testValidator(baseValidator,
            resourceValidator, HeatResourcesTypes.NOVA_SERVER_RESOURCE_TYPE.getHeatResource(),
            "/org/openecomp/validation/validators/guideLineValidator/heatNovaNetworkUniqueRoleConvention/missingportNetwork/");
    Assert.assertNotNull(messages);
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().size(), 4);
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
  ...
  public void testEnvFileContent() {
    Map<String, MessageContainer> messages = ValidationTestUtil.testValidator(baseValidator,
            resourceValidator, HeatResourcesTypes.NOVA_SERVER_RESOURCE_TYPE.getHeatResource(),
            "/org/openecomp/validation/validators/guideLineValidator/heatNovaNetworkUniqueRoleConvention/input/");
    Assert.assertNotNull(messages);
