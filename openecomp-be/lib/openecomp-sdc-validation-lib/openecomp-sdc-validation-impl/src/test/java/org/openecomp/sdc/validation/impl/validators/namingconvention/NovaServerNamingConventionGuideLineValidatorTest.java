...
public class NovaServerNamingConventionGuideLineValidatorTest {
  ...
  public void testHeatNovaServerMetaDataValidation() {
    ...
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
        "WARNING: [K-3] : Missing VNF_ID in Metadata property, Resource ID [FSB2]");
  }
  ...
  public void testNovaServerAvailabilityZoneName() {
    ...
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
        "WARNING: [K-5] : Server 'Availability Zone' Parameter Name not aligned with Guidelines, Parameter Name [availability_zone_a], Resource ID [FSB2]. As a result, VF/VFC Profile may miss this information");
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(1).getMessage(),
        "WARNING: [K-5] : Server 'Availability Zone' Parameter Name not aligned with Guidelines, Parameter Name [availability_zone], Resource ID [FSB3]. As a result, VF/VFC Profile may miss this information");
  }
  ...
  public void testNovaResourceNetworkUniqueRole() {
    ...
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().size(), 1);
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
        "WARNING: [K-13] : A resource is connected twice to the same network role, Network Role [FSB2], Resource ID [Internal1]");
  }
  ...
  public void testNovaServerName() {
    ...
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().size(), 2);
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
        "WARNING: [K-11] : Server 'name' Parameter Name not aligned with Guidelines, Parameter Name [pcrf_pps_server_4], Resource ID [FSB2]. As a result, VF/VFC Profile may miss this information");
  }
  ...
  public void testVMNameSyncInNova() {
    ...
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(0).getMessage(),
        "WARNING: [K-11] : Server 'name' Parameter Name not aligned with Guidelines, Parameter Name [CE_server_name], Resource ID [FSB2_legal_2]. As a result, VF/VFC Profile may miss this information");
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(1).getMessage(),
    ...
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(2).getMessage(),
        "WARNING: [K-12] : Nova Server naming convention in image, flavor and name properties is not consistent, Resource ID [FSB2_illegal_1]");
    Assert.assertEquals(messages.get("first.yaml").getErrorMessageList().get(3).getMessage(),
        "WARNING: [K-12] : Nova Server naming convention in image, flavor and name properties is not consistent, Resource ID [FSB2_illegal_2]");
  }
  ...
  public void testAvailabilityZoneName() throws IOException {
    ...
    Assert.assertEquals(
        ...
        "WARNING: [K-5] : Server 'Availability Zone' Parameter Name not aligned with Guidelines, Parameter Name [availability_zone_name], Resource ID [availability_zone_illegal_name_1]. As a result, VF/VFC Profile may miss this information");
    Assert.assertEquals(
        messages.get("hot-nimbus-pps_v1.0.yaml").getErrorMessageList().get(1).getMessage(),
        "WARNING: [K-5] : Server 'Availability Zone' Parameter Name not aligned with Guidelines, Parameter Name [availability_zone], Resource ID [availability_zone_illegal_name_2]. As a result, VF/VFC Profile may miss this information");
  }
}
