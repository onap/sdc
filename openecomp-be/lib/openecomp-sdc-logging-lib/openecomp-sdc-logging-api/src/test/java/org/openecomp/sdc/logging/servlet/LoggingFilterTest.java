...
public class LoggingFilterTest extends PowerMockTestCase {
    ...
    public void filterPopulatesValuesWhenNoInitParamsAndNoHeaders() throws Exception {
        ...
        mockServiceNameLoggingContext(RANDOM_REQUEST_URI);
    ...
    public void filterPopulatesValuesWhenNoInitParamsAndExistingHeaders() throws Exception {
        ...
        mockAllLoggingContext(RANDOM_REQUEST_ID, RANDOM_REQUEST_URI, RANDOM_PARTNER_NAME);
    ...
    private void mockServiceNameLoggingContext(String serviceName) {
        mockAllLoggingContext(null, serviceName, null);
    }

    private void mockAllLoggingContext(String requestId, String serviceId, String partnerId) {
