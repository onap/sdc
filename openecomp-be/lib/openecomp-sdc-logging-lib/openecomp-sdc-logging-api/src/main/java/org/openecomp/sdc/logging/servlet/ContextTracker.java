...
public class ContextTracker implements Tracker {
     ...
     * @param serviceName supplier of a service name, cannot be null
     */
    public ContextTracker(HttpHeader partnerNameHeaders, HttpHeader requestIdHeaders, Supplier<String> serviceName) {
    ...
    public void preRequest(HttpServletRequest request) {
        ...
        ContextData.ContextDataBuilder contextBuilder =
                ContextData.builder().serviceName(serviceName.get()).requestId(requestId);
