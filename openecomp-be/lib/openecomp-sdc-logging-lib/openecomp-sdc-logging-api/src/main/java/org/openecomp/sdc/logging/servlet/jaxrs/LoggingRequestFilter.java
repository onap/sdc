...
public class LoggingRequestFilter implements ContainerRequestFilter {
    ...
    public void setRequestIdHeader(String requestIdHeader) {
        this.requestIdHeader = new HttpHeader(requestIdHeader.split(MULTI_VALUE_SEPARATOR));
    }
    ...
    public void setPartnerNameHeader(String partnerNameHeader) {
        this.partnerNameHeader = new HttpHeader(partnerNameHeader.split(MULTI_VALUE_SEPARATOR));
    }
