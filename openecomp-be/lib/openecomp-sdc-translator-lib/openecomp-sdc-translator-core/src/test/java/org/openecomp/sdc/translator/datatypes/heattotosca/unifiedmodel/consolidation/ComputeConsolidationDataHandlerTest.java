...
public class ComputeConsolidationDataHandlerTest {
    ...
    @Mock
    private ComputeConsolidationData computeConsolidationDataMock;
    ...
    public void isNumberOfComputeTypesLegalPositive() {
        ComputeConsolidationDataHandler computeConsolidationDataHandler =
                new ComputeConsolidationDataHandler(computeConsolidationDataMock);

        computeConsolidationDataHandler.isNumberOfComputeTypesLegal(MAIN_SERVICE_TEMPLATE);

        Mockito.verify(computeConsolidationDataMock).isNumberOfComputeTypesLegal(MAIN_SERVICE_TEMPLATE);
    }
}
