...
public class EntityConsolidationDataTest {
    ...
    @Test
    public void testIsGetAttrOutFromEntityLegal_NullEntityConsolidationDataList() {
        EntityConsolidationData entityConsolidationData = new EntityConsolidationData();
        Assert.assertTrue(entityConsolidationData.isGetAttrOutFromEntityLegal(null, null));
    }

    @Test
    public void testIsGetAttrOutFromEntityLegal_EmptyEntityConsolidationDataList() {
        EntityConsolidationData entityConsolidationData = new EntityConsolidationData();
        Assert.assertTrue(entityConsolidationData.isGetAttrOutFromEntityLegal(Collections.emptyList(), null));
    }
