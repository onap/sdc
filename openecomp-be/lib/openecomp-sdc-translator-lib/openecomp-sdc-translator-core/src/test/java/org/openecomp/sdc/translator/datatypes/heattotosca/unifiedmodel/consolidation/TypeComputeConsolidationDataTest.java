...
public class TypeComputeConsolidationDataTest {
    ...
    public void testAddComputeTemplateConsolidationData() {
        ...
        consolidationData.addComputeTemplateConsolidationData(computeNodeTemplateId1);

        Set<String> expectedNodeTemplateIds =  new HashSet();
        expectedNodeTemplateIds.add(computeNodeTemplateId1);
        verifyComputeTemplateConsolidationData(consolidationData, computeNodeTemplateId1, expectedNodeTemplateIds);
    }
    ...
    public void testAddSameConsolidationDataTwice_noNewCreated() {
        ...
        ComputeTemplateConsolidationData firstComputeTemplateConsolidationData =
                consolidationData.getComputeTemplateConsolidationData(computeNodeTemplateId1);
    ...
    public void testAddDiffConsolidationData_DiffNodeTemplateId() {
        ...
        final ComputeTemplateConsolidationData firstComputeTemplateConsolidationData = consolidationData
                .addComputeTemplateConsolidationData(computeNodeTemplateId1);
        Set<String> expectedNodeTemplateIds1 =  new HashSet();
        expectedNodeTemplateIds1.add(computeNodeTemplateId1);
        verifyComputeTemplateConsolidationData(consolidationData, computeNodeTemplateId1, expectedNodeTemplateIds1);

        String computeNodeTemplateId2 = "computeNodeTemplateId2";
        final ComputeTemplateConsolidationData secondComputeTemplateConsolidationData = consolidationData
                .addComputeTemplateConsolidationData(computeNodeTemplateId2);
        Set<String> expectedNodeTemplateIds2 =  new HashSet();
        expectedNodeTemplateIds2.add(computeNodeTemplateId2);
        verifyComputeTemplateConsolidationData(consolidationData, computeNodeTemplateId2, expectedNodeTemplateIds2);
