...
public class TypeComputeConsolidationDataTest {
    ...
    private Map<String, List<String>> multipleNumberOfPortTypeMap = new HashMap<String, List<String>>() {
        {
            put("oam_untr_port", Collections.singletonList("oam_1_untr_port_1"));
            put("cmaui_untr_port", Collections.singletonList("cmaui_1_untr_port_1"));
        }
    };

    Map<String, List<String>> multipleNumberOfPortInEachTypeTypeMap = new HashMap<String, List<String>>() {
        {
    ...
    public void isThereMoreThanOneComputeTypeInstancePositive() {
        TypeComputeConsolidationData typeComputeConsolidationData = new TypeComputeConsolidationData();
        typeComputeConsolidationData.setComputeTemplateConsolidationData(SERVER_OAM, new ComputeTemplateConsolidationData());
    ...
    @Test
    public void isNumberOfPortFromEachTypeLegalBothComputeHaveMorePortNegative() {
        ...
        secondComputeTemplate.setPorts(multipleNumberOfPortInEachTypeTypeMap);
        ...
        Assert.assertFalse(typeComputeConsolidationData.isNumberOfPortFromEachTypeLegal());
    }

    @Test
    public void isNumberOfPortFromEachTypeLegalOneComputeHaveMorePortNegative() {
        ComputeTemplateConsolidationData firstComputeTemplate = new ComputeTemplateConsolidationData();
        firstComputeTemplate.setPorts(multipleNumberOfPortInEachTypeTypeMap);

        ComputeTemplateConsolidationData secondComputeTemplate = new ComputeTemplateConsolidationData();
        secondComputeTemplate.setPorts(new HashMap<String, List<String>>() {
            {
                put("oam_untr_port", Collections.singletonList("oam_1_untr_port_1"));
            }
        });
    ...
    @Test
    public void isNumberOfPortFromEachTypeLegalAllComputeHaveOnePortPositive() {
        TypeComputeConsolidationData typeComputeConsolidationData = new TypeComputeConsolidationData();
        ...
        Assert.assertTrue(typeComputeConsolidationData.isNumberOfPortFromEachTypeLegal());
    }

    @Test
    public void isNumberOfPortFromEachTypeLegalAllComputeHaveNoPortPositive() {
        TypeComputeConsolidationData typeComputeConsolidationData = new TypeComputeConsolidationData();
        typeComputeConsolidationData.setComputeTemplateConsolidationData(SERVER_OAM, new ComputeTemplateConsolidationData());
        typeComputeConsolidationData.setComputeTemplateConsolidationData(SERVER_CMAUI, new ComputeTemplateConsolidationData());
