...
public class FileComputeConsolidationData {
    ...
    *
    * @return compute template consolidation data
    */
    ComputeTemplateConsolidationData addTypeComputeConsolidationData(
                      String computeNodeType, String computeNodeTemplateId) {

        TypeComputeConsolidationData consolidationData = addTypeComputeConsolidationData(computeNodeType);
        return consolidationData.addComputeTemplateConsolidationData(computeNodeTemplateId);
    }

    private TypeComputeConsolidationData addTypeComputeConsolidationData(String computeNodeType) {
        TypeComputeConsolidationData consolidationData = getTypeComputeConsolidationData(computeNodeType);
        if (consolidationData == null) {
            consolidationData = new TypeComputeConsolidationData();
            setTypeComputeConsolidationData(computeNodeType, consolidationData);
        }
