...
public class FileNestedConsolidationData {
    ...
    */
    NestedTemplateConsolidationData addNestedTemplateConsolidationData(String nestedNodeTemplateId) {
        NestedTemplateConsolidationData consolidationData = nestedTemplateConsolidationData
                .computeIfAbsent(nestedNodeTemplateId, k -> new NestedTemplateConsolidationData());
