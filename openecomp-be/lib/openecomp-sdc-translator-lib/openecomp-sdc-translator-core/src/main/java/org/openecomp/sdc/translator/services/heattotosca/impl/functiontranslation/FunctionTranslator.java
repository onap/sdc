...
public class FunctionTranslator {
    ...
    private final String unsupportedResourcePrefix = "UNSUPPORTED_RESOURCE_";
    private final String unsupportedAttributePrefix = "UNSUPPORTED_ATTRIBUTE_";
    ...
    String getUnsupportedResourcePrefix() {
        return unsupportedResourcePrefix;
    }

    String getUnsupportedAttributePrefix() {
        return unsupportedAttributePrefix;
    }

    public boolean isResourceSupported(String translatedResourceId) {
        return !translatedResourceId.startsWith(unsupportedResourcePrefix);
    }

    boolean isAttributeSupported(String translatedAttName) {
        return !translatedAttName.startsWith(unsupportedAttributePrefix);
    }
}
