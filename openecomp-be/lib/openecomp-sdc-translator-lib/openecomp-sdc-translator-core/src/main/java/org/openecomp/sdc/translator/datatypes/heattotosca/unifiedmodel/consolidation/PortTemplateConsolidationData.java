...
public class PortTemplateConsolidationData extends EntityConsolidationData {
  ...
  private final ListMultimap<String, SubInterfaceTemplateConsolidationData>
      subInterfaceConsolidationData = Multimaps
      .synchronizedListMultimap(ArrayListMultimap.create());

  public ListMultimap<String, SubInterfaceTemplateConsolidationData> getSubInterfaceConsolidationData() {
