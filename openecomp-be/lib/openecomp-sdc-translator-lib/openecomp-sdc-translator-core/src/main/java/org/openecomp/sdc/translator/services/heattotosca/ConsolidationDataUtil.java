...
public class ConsolidationDataUtil {
    ...
    private static SubInterfaceTemplateConsolidationData getSubInterfaceTemplateConsolidationData(
        ...
        return portTemplateConsolidationData.addSubInterfaceResourceTemplateConsolidationData(
    ...
    public static void updatePortInConsolidationData(TranslateTo translateTo,
        ...
        translationContext.getConsolidationData().getPortConsolidationDataHandler()
                .addPortTemplateConsolidationData(serviceTemplateFileName, portResourceId,
    ...
    public static void updateNestedNodeTemplateId(TranslateTo translateTo) {
        ...
        context.getConsolidationData().getNestedConsolidationDataHandler()
                .addNestedTemplateConsolidationData(serviceTemplateFileName, context,
