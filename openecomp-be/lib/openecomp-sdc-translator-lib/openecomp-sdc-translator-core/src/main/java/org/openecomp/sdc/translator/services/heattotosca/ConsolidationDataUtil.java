...
public class ConsolidationDataUtil {
    ...
    public static void updateNodesConnectedIn(TranslateTo translateTo, String sourceNodeTemplateId,
        ...
        consolidationDataHandler.ifPresent(handler -> handler.addNodesConnectedIn(
                translateTo, sourceNodeTemplateId, dependentNodeTemplateId, targetResourceId, requirementId, requirementAssignment));
    ...
    public static void removeSharedResource(ServiceTemplate serviceTemplate,
        ...
        consolidationDataHandler.ifPresent(handler->
                                                   handler.removeParamNameFromAttrFuncList(
                                                           serviceTemplate, heatOrchestrationTemplate, paramName,
                                                           contrailSharedResourceId, sharedTranslatedResourceId));
    }


    public static Optional <ConsolidationDataHandler> getConsolidationDataHandler(HeatOrchestrationTemplate heatOrchestrationTemplate,
                                                                                          TranslationContext context,
                                                                                          String contrailSharedResourceId) {
        ...
        return context.getConsolidationData().
                                                     getConsolidationDataHandler(consolidationEntityType.getSourceEntityType());
