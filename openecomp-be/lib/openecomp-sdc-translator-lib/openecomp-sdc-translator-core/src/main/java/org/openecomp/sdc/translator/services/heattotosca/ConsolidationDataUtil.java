...
public class ConsolidationDataUtil {
  ...
  public static PortTemplateConsolidationData getPortTemplateConsolidationData(TranslationContext context,
    ...
    if (portTemplateConsolidationData == null) {
      ...
      String portNetworkRole = HeatToToscaUtil.evaluateNetworkRoleFromResourceId(portResourceId, portResourceType);
      portTemplateConsolidationData.setNetworkRole(portNetworkRole);
  ...
  public static SubInterfaceTemplateConsolidationData getSubInterfaceTemplateConsolidationData(
      Resource resource,
      TranslationContext context,
      ServiceTemplate serviceTemplate,
      String heatFileName,
    ...
    Optional<String> parentPortNodeTemplateId =
        HeatToToscaUtil.getSubInterfaceParentPortNodeTemplateId(resource, serviceTemplate,
            heatFileName, heatOrchestrationTemplate, context);
    if (parentPortNodeTemplateId.isPresent()) {
      return getSubInterfaceTemplateConsolidationData(resource, context, serviceTemplate,
  ...
  /**
   * Gets sub interface template consolidation data.
   *
   * @param resource           the resource
   * @param context            the context
   * @param serviceTemplate    the service template
   * @param subInterfaceNodeTemplateId the sub interface node template id
   * @return the sub interface template consolidation data
   */
  private static SubInterfaceTemplateConsolidationData getSubInterfaceTemplateConsolidationData(
    ...
    String subInterfaceResourceType = HeatToToscaUtil.getSubInterfaceResourceType(resource);
    String subInterfaceType = ToscaNodeType.VLAN_SUB_INTERFACE_RESOURCE_TYPE_PREFIX
        + FileUtils.getFileWithoutExtention(subInterfaceResourceType);
  ...
  private static boolean isConsolidationEntity(ConsolidationEntityType consolidationEntityType) {
    return consolidationEntityType.getSupportedConsolidationEnties()
        .contains(consolidationEntityType);
  }
  ...
  public static void updateNodesConnectedOut(TranslateTo translateTo,
    ...
    if (consolidationEntityType == ConsolidationEntityType.COMPUTE) {
      ...
      entityConsolidationData = getSubInterfaceTemplateConsolidationData(translateTo
              .getResource(), translationContext, serviceTemplate, translateTo.getHeatFileName(),
          translateTo.getHeatOrchestrationTemplate(), translateTo.getTranslatedId());
  ...
  public static void updateNodesConnectedIn(TranslateTo translateTo, String sourceNodeTemplateId,
    ...
    if (consolidationEntityType == ConsolidationEntityType.COMPUTE) {
      ...
      Resource targetResource =
          translateTo.getHeatOrchestrationTemplate().getResources().get(targetResourceId);
      entityConsolidationData = getSubInterfaceTemplateConsolidationData(targetResource,
          translationContext, serviceTemplate, translateTo.getHeatFileName(), translateTo
              .getHeatOrchestrationTemplate(), targetResourceId);
