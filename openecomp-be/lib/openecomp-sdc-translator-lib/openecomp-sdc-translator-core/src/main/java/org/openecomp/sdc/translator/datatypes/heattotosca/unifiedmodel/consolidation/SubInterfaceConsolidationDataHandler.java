...
public class SubInterfaceConsolidationDataHandler extends BaseConsolidationDataHandler {
    ...
    public void addNodesConnectedOut(TranslateTo translateTo, String nodeTemplateId, String requirementId, RequirementAssignment requirementAssignment) {
        ...
        if (Objects.nonNull(serviceTemplate.getTopology_template().getNode_templates()
            ...
            subInterfaceTemplateConsolidationData.ifPresent(
                    templateConsolidationData->
                            addNodesConnectedOut (templateConsolidationData, nodeTemplateId, requirementId, requirementAssignment));
        }
    }
    ...
    public void addNodesConnectedIn(TranslateTo translateTo, String sourceNodeTemplateId, String dependentNodeTemplateId, String targetResourceId, String requirementId, RequirementAssignment requirementAssignment) {
        ServiceTemplate serviceTemplate = getServiceTemplate(translateTo);
        TranslationContext translationContext = getTranslationContext(translateTo);
        ...
        subInterfaceTemplateConsolidationData.ifPresent(
                templateConsolidationData-> addNodesConnectedIn(templateConsolidationData, sourceNodeTemplateId, requirementId, requirementAssignment));
