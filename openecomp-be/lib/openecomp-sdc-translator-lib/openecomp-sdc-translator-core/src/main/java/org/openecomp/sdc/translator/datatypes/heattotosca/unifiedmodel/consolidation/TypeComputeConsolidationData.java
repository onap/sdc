...
public class TypeComputeConsolidationData {
    ...
    public Map<String, List<String>> collectAllPortsOfEachTypeFromComputes() {
        ...
        computeTemplateConsolidationDataCollection.forEach(
                computeTemplateConsolidationData1 -> computeTemplateConsolidationData1
                                                             .collectAllPortsOfEachTypeFromCompute(portTypeToIds));
