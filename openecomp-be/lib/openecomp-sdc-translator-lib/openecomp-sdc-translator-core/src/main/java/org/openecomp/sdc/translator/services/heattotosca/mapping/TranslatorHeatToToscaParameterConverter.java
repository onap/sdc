...
public class TranslatorHeatToToscaParameterConverter {
  ...
  public static ParameterDefinitionExt getToscaParameter(ServiceTemplate serviceTemplate,
    ...
    Optional<Map<String, AnnotationDefinition>>  annotaions = getToscaAnnotations(context, serviceTemplate, heatFileName, heatParameterName, toscaParameterName);
    annotaions.ifPresent(ant->toscaParameter.setAnnotations(annotaions.get()));


    return toscaParameter;
  }

  private static Optional<Map<String, AnnotationDefinition> > getToscaAnnotations (TranslationContext context, ServiceTemplate serviceTemplate, String heatFileName, String heatParameterName, String toscaParameterName){
