...
public class ConsolidationTypesConnectivity {
    ...
    private static Map<ConsolidationEntityType, Set<ConsolidationEntityType>> entityToEntitiesWithoutRelationship =
            new EnumMap<>(ConsolidationEntityType.class);

    static {
        entityToEntitiesWithoutRelationship.put(ConsolidationEntityType.COMPUTE, getIgnoredComputeRelationships());
        entityToEntitiesWithoutRelationship.put(ConsolidationEntityType.PORT, getIgnoredPortRelationships());
        entityToEntitiesWithoutRelationship.put(ConsolidationEntityType.VOLUME, getIgnoredVolumeRelationships());
        entityToEntitiesWithoutRelationship.put(ConsolidationEntityType.VFC_NESTED, getIgnoredVfcNestedRelationships());
        entityToEntitiesWithoutRelationship.put(ConsolidationEntityType.NESTED, getIgnoredNestedRelationships());
    }
    ...
    private static Set<ConsolidationEntityType> getIgnoredComputeRelationships() {
        return Stream.of(ConsolidationEntityType.COMPUTE, ConsolidationEntityType.VOLUME, ConsolidationEntityType.PORT,
                ConsolidationEntityType.NESTED, ConsolidationEntityType.VFC_NESTED).collect(Collectors.toSet());
    }
    ...
    private static Set<ConsolidationEntityType> getIgnoredNestedRelationships() {
        return Stream.of(ConsolidationEntityType.COMPUTE, ConsolidationEntityType.PORT, ConsolidationEntityType.NESTED,
