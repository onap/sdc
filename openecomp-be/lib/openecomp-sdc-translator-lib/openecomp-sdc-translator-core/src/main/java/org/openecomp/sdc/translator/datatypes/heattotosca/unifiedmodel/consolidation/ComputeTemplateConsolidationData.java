...
public class ComputeTemplateConsolidationData extends EntityConsolidationData {
    ...
    public void collectAllPortsOfEachTypeFromCompute(Map<String, List<String>> portTypeToIds) {
        Map<String, List<String>> portsConnectedToCompute = getPorts();
        if (!MapUtils.isEmpty(portsConnectedToCompute)) {

            addPortsToMap(portTypeToIds, portsConnectedToCompute);
        }
    }

    private void addPortsToMap(Map<String, List<String>> portTypeToIds, Map<String, List<String>> ports) {
