...
public class ComputeTemplateConsolidationData extends EntityConsolidationData {
    ...
    */
    ...
    /**
    * Gets all ports per port type, which are connected to the compute consolidation data entity
    * computeTemplateConsolidationData.
    *
    * @return Map containing key as port type and value as ports id
    */
    public Map<String, List<String>> collectAllPortsOfEachTypeFromCompute() {
