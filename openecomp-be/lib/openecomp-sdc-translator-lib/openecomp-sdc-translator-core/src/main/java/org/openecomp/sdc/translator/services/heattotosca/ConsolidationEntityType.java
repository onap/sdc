...
public enum ConsolidationEntityType {
  ...
  public List<ConsolidationEntityType> getSupportedConsolidationEnties() {
    List<ConsolidationEntityType> consolidationEntityTypes =
        Arrays.asList(ConsolidationEntityType.values());
    return consolidationEntityTypes.stream()
