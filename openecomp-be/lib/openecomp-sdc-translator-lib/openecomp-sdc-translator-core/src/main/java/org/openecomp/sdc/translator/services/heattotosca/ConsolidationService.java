...
public class ConsolidationService {
  ...
  private boolean isPropertyExistInNodeTemplate(String propertyToCheck, NodeTemplate nodeTemplate) {
    ...
    private boolean ifNestedFileContainsOnlySubInterface(ServiceTemplate serviceTemplate, TranslationContext context) {
        ...
        Set<String> substituteServiceTemplateNames = getSubstituteServiceTemplateNames(nestedNodeTemplateMap);

        return ifAllResourceAreSubInterface(substituteServiceTemplateNames, context);
    }
    ...
    private boolean ifAllResourceAreSubInterface(Set<String> substituteServiceTemplateNames,
                                                      TranslationContext context) {
        for (String fileName : substituteServiceTemplateNames) {
