...
public class ConsolidationService {
  ...
  private boolean isPropertyExistInNodeTemplate(String propertyToCheck, NodeTemplate nodeTemplate) {
    ...
    private boolean ifNestedFileContainsOnlySubInterface(ServiceTemplate serviceTemplate, TranslationContext context) {
        ...
        Set<String> substituteServiceTemplateNamesNames = getSubstituteServiceTemplateNames(nestedNodeTemplateMap);

        return ifAllResourceAreSubInterface(substituteServiceTemplateNamesNames, context);
    }

    private Set<String> getSubstituteServiceTemplateNames(Map<String, NodeTemplate> nestedNodeTemplateMap) {
    ...
    private boolean ifAllResourceAreSubInterface(Set<String> substituteServiceTemplateNamesNames,
                                                      TranslationContext context) {
        for (String fileName : substituteServiceTemplateNamesNames) {
