...
public class ConsolidationService {
    ...
    for (String portType : portTypeToIds.keySet()) {
      ...
      Set<GetAttrFuncData> startingGetAttrFunc =
          getEntityGetAttrFuncAsSet(portType,
              (EntityConsolidationData) iterator.next());
      while (iterator.hasNext()) {
        EntityConsolidationData entity = (EntityConsolidationData) iterator.next();
        Set<GetAttrFuncData> currentGetAttrFuncData =
            getEntityGetAttrFuncAsSet(portType, entity);
  ...
  private boolean checkEntityConsolidationDataRelations(Collection entities) {
    Iterator iterator = entities.iterator();
    EntityConsolidationData startingEntity = (EntityConsolidationData) iterator.next();

    while (iterator.hasNext()) {
      EntityConsolidationData currentEntity = (EntityConsolidationData) iterator.next();
  ...
  private boolean isNumberOfPortsEqualsBetweenComputeNodes(
      TypeComputeConsolidationData typeComputeConsolidationData) {
    Iterator<ComputeTemplateConsolidationData> iterator =
        typeComputeConsolidationData.getAllComputeTemplateConsolidationData().iterator();

    int startingNumberOfPorts =
        getNumberOfPortsPerCompute(iterator.next());

    while (iterator.hasNext()) {
      int currNumberOfPorts = getNumberOfPortsPerCompute(iterator.next());
  ...
  private boolean isPortTypesEqualsBetweenComputeNodes(
    ...
    Iterator<ComputeTemplateConsolidationData> iterator =
        typeComputeConsolidationData.getAllComputeTemplateConsolidationData().iterator();
    Set<String> staringPortIds = getPortsIds(iterator.next());

    while (iterator.hasNext()) {
      Set<String> currentPortIds = getPortsIds(iterator.next());
