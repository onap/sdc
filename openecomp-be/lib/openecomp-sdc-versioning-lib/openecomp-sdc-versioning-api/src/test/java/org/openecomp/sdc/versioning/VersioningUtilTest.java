...
import org.openecomp.sdc.versioning.dao.types.VersionInfoDaoImplTest;
import org.openecomp.sdc.versioning.dao.types.VersionableEntityImplTest;
...
public class VersioningUtilTest {
    ...
    public void testResolveVersion() {
        ...
        Assert.assertNotNull(VersioningUtil.resolveVersion(version, versionInfo, "user"));
    ...
    public void testResolveVersionNegative() {
        ...
        versionInfo.setLockingUser("user");
        Assert.assertNotNull(VersioningUtil.resolveVersion(null, versionInfo, "user"));
    ...
    public void testResolveVersionWithNonFinalVersions() {
        ...
        versionInfo.setViewableVersions(Arrays.asList(new Version()));
        versionInfo.setLatestFinalVersion(version);
        Assert.assertNotNull(VersioningUtil.resolveVersion(version, versionInfo, true));
    ...
    public void testValidateEntityExistence() {
        VersioningUtil.validateEntityExistence(null, new VersionableEntityImplTest(), "firstClassCitizenType");
    }
    ...
    public void testValidateEntitiesExistence() {
        ...
        entityIds.add("id1");
        entityIds.add("id2");
        VersioningUtil.validateEntitiesExistence(entityIds, new VersionableEntityImplTest(),
                new VersionInfoDaoImplTest(),"firstClassCitizenType");
    }
    ...
    public void testValidateContainedEntitiesExistence() {
        ...
        VersioningUtil.validateContainedEntitiesExistence("containedEntityType",
                inputContainedEntityIds, new VersionableEntityImplTest(), retrievedContainedEntityIds);
    }
