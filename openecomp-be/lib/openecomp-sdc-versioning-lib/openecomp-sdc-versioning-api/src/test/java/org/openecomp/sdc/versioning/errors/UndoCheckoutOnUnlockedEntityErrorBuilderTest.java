...
public class UndoCheckoutOnUnlockedEntityErrorBuilderTest {
    ...
    public void test() {
        ...
        Assert.assertEquals(String.format("Can not undo checkout on versionable entity %s with id %s since it is not checked out.", "entityType", "entityId"), build.message());
    }
}