...
public class EntityAlreadyFinalizedErrorBuilder extends BaseErrorBuilder {
    ...
    static final String SUBMIT_FINALIZED_ENTITY_NOT_ALLOWED_MSG = "Versionable entity %s with id %s can not be submitted since it is already final.";
    ...
    public EntityAlreadyFinalizedErrorBuilder(String entityType, String entityId) {
        ...
        getErrorCodeBuilder().withMessage(String.format(SUBMIT_FINALIZED_ENTITY_NOT_ALLOWED_MSG, entityType, entityId));
    }
}
