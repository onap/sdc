...
public class CheckinOnEntityLockedByOtherErrorBuilder extends BaseErrorBuilder {
    ...
    static final String CHECKIN_ON_ENTITY_LOCKED_BY_OTHER_USER_MSG =
        "Can not check in versionable entity %s with id %s since it is checked out by other " + "user: %s.";
     ...
     */
    public CheckinOnEntityLockedByOtherErrorBuilder(String entityType, String entityId, String lockingUser) {
        ...
        getErrorCodeBuilder().withMessage(String.format(CHECKIN_ON_ENTITY_LOCKED_BY_OTHER_USER_MSG, entityType, entityId, lockingUser));
    }
}
