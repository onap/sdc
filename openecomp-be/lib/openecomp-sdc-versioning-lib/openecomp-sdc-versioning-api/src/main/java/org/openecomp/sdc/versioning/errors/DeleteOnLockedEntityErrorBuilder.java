...
public class DeleteOnLockedEntityErrorBuilder extends BaseErrorBuilder {
    ...
    static final String DELETE_ON_LOCKED_ENTITY_MSG = "Can not delete versionable entity %s with id %s since it is checked out by other user: %s.";
    ...
    public DeleteOnLockedEntityErrorBuilder(String entityType, String entityId, String lockingUser) {
        ...
        getErrorCodeBuilder().withMessage(String.format(DELETE_ON_LOCKED_ENTITY_MSG, entityType, entityId, lockingUser));
    }
}
