...
public class SubmitLockedEntityNotAllowedErrorBuilder extends BaseErrorBuilder {
    ...
    static final String SUBMIT_LOCKED_ENTITY_NOT_ALLOWED_MSG =
        "Versionable entity %s with id %s can not be submitted since it is currently" + " locked by user %s.";
     ...
     */
    public SubmitLockedEntityNotAllowedErrorBuilder(String entityType, String entityId, String lockingUser) {
        ...
        getErrorCodeBuilder().withMessage(String.format(SUBMIT_LOCKED_ENTITY_NOT_ALLOWED_MSG, entityType, entityId, lockingUser));
    }
}
