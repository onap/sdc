...
public class EntityAlreadyExistErrorBuilder extends BaseErrorBuilder {
    ...
    static final String VERSIONABLE_ENTITY_ALREADY_EXIST_MSG = "Versionable entity %s with id %s already exist.";
    ...
    public EntityAlreadyExistErrorBuilder(String entityType, String entityId) {
        ...
        getErrorCodeBuilder().withMessage(String.format(VERSIONABLE_ENTITY_ALREADY_EXIST_MSG, entityType, entityId));
    }
}
