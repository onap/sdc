...
public class UndoCheckoutOnUnlockedEntityErrorBuilder extends BaseErrorBuilder {
    ...
    static final String UNDO_CHECKOUT_ON_UNLOCKED_ENTITY_MSG = "Can not undo checkout on versionable entity %s with id %s since it is not checked out.";
    ...
    public UndoCheckoutOnUnlockedEntityErrorBuilder(String entityType, String entityId) {
        ...
        getErrorCodeBuilder().withMessage(String.format(UNDO_CHECKOUT_ON_UNLOCKED_ENTITY_MSG, entityType, entityId));
    }
}
