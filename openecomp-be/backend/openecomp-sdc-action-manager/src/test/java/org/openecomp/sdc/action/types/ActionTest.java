...
public class ActionTest {
    ...
    private void assertEqualsMultipleAssert(Action source, ActionEntity destination) {
        assertEquals(source.getName(),destination.getName().toLowerCase());
        assertEquals(source.getActionUuId(),destination.getActionUuId().toUpperCase());
        assertEquals(source.getActionInvariantUuId(),destination.getActionInvariantUuId().toUpperCase());
