...
public class SOL004MetaDirectoryValidatorTest {
    ...
    public void testGivenDefinitionFile_whenValidImportStatementExist_thenNoErrorsReturned() {
        ...
        handler.addFile("Definitions/etsi_nfv_sol001_pnfd_2_5_1_types.yaml", getResourceBytesOrFail(SAMPLE_DEFINITION_FILE_PATH));
    ...
    public void testGivenDefinitionFile_whenMultipleDefinitionsImportStatementExist_thenNoErrorsReturned() {
        ...
        final byte [] sampleDefinitionFile1 = getResourceBytesOrFail("validation.files/definition/sampleDefinitionFile1.yaml");
        handler.addFile(TOSCA_DEFINITION_FILEPATH, sampleDefinitionFile1);
        manifestBuilder.withSource(TOSCA_DEFINITION_FILEPATH);

        final byte [] sampleDefinitionFile2 = getResourceBytesOrFail("validation.files/definition/sampleDefinitionFile2.yaml");
        handler.addFile("Definitions/etsi_nfv_sol001_pnfd_2_5_1_types.yaml", sampleDefinitionFile2);
        manifestBuilder.withSource("Definitions/etsi_nfv_sol001_pnfd_2_5_1_types.yaml");

        final byte [] sampleDefinitionFile3 = getResourceBytesOrFail("validation.files/definition/sampleDefinitionFile1.yaml");
    ...
    public void testGivenDefinitionFile_whenReferencedImportDoesNotExist_thenErrorIsReturned() {
        ...
        manifestBuilder.withSource(TOSCA_DEFINITION_FILEPATH);
        handler.addFile(TOSCA_DEFINITION_FILEPATH, getResourceBytesOrFail("validation.files/definition/sampleDefinitionFile2.yaml"));
    ...
    public void testGivenDefinitionFileWithImportedDescriptor_whenImportedDescriptorImportsMissingFile_thenMissingImportErrorOccur() {
        ...
        handler.addFile(definitionImportOne, getResourceBytesOrFail("validation.files/definition/sampleDefinitionFile2.yaml"));
    ...
    public void testGivenDefinitionFileWithImportedDescriptor_whenInvalidImportStatementExistInImportedDescriptor_thenInvalidImportErrorOccur() {
        ...
        final String definitionImportOne = "Definitions/importOne.yaml";
        handler.addFile(definitionImportOne, getResourceBytesOrFail("validation.files/definition/definitionFileWithInvalidImport.yaml"));
        manifestBuilder.withSource(definitionImportOne);
    ...
    public void givenManifestWithNonManoPmAndVesArtifacts_whenNonManoArtifactsAreValid_thenNoErrorsOccur() {
        ...
        handler.addFile(nonManoPmEventsSource, getResourceBytesOrFail("validation.files/measurements/pmEvents-valid.yaml"));
        ...
        handler.addFile(nonManoVesEventsSource, getResourceBytesOrFail("validation.files/events/vesEvents-valid.yaml"));
    ...
    @Test
    public void givenPackageWithUnparsableSoftwareInformationNonMano_whenThePackageIsValidated_thenInvalidErrorsIsReturned() {
    ...
    @Test
    public void givenPackageWithIncorrectSoftwareInformationNonMano_whenThePackageIsValidated_thenInvalidErrorsIsReturned() {
