...
public class PackageNotFoundErrorBuilderTest {
    ...
    public void testBuild() {
        PackageNotFoundErrorBuilder packageNotFoundErrorBuilder = new PackageNotFoundErrorBuilder("1");

        ErrorCode errorCode = packageNotFoundErrorBuilder.build();

        assertEquals(VendorSoftwareProductErrorCodes.PACKAGE_NOT_FOUND, errorCode.id());
