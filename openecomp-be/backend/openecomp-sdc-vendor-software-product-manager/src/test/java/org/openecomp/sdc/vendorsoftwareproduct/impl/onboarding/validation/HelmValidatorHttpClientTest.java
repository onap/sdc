...
public class HelmValidatorHttpClientTest {
    ...
    public static final String HTTPS_TEST_URL = "https://test-url";
    public static final String TEST_VERSION = "3.5.6";
    @Mock
    HttpRequestHandler httpRequestHandler;
    @Mock
    HelmValidatorConfig helmValidatorConfig;
    @InjectMocks
    HelmValidatorHttpClient client;
    @Captor
    ...
    @BeforeEach
    public void init() throws HttpExecuteException {
    ...
    public void shouldSendPostToValidatorUrl(String validatorUrl) throws HttpExecuteException {
    ...
    public void shouldPrepareRequestWithDesiredVersion(String desiredVersion) throws IOException, HttpExecuteException {
        //given
    ...
    public void shouldPrepareRequestWithChartFromConfig(String testChartFileName, String testChartContent)
        throws HttpExecuteException, IOException {
        //given
    ...
    @Test
    public void shouldPrepareLintableRequest() throws HttpExecuteException, IOException {
        //given
        Path chartPath = getTestPath(TEST_CHART_FILE_NAME, "");
    ...
    @Test
    public void shouldPrepareStrictLintableRequest() throws HttpExecuteException, IOException {
        //given
        Path chartPath = getTestPath(TEST_CHART_FILE_NAME, "");
