...
public class CompositionEntityDataManagerFactoryImpl extends CompositionEntityDataManagerFactory {
    ...
    public CompositionEntityDataManager createInterface() {
        ...
        return new CompositionEntityDataManagerImpl(VendorSoftwareProductInfoDaoFactory.getInstance().createInterface(),
            ComponentDaoFactory.getInstance().createInterface(), NicDaoFactory.getInstance().createInterface(),
            NetworkDaoFactory.getInstance().createInterface(), ImageDaoFactory.getInstance().createInterface(),
            ComputeDaoFactory.getInstance().createInterface(), DeploymentFlavorDaoFactory.getInstance().createInterface());
    }
}
