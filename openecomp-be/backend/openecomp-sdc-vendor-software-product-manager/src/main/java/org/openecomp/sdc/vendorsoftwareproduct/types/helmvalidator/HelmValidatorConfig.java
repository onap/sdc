...
public class HelmValidatorConfig {
    ...
    public static class HelmValidationConfigBuilder {
        ...
        private String helmValidatorUrl;
        ...
        public HelmValidationConfigBuilder setHelmValidatorUrl(String helmValidatorUrl) {
            this.helmValidatorUrl = helmValidatorUrl;
            return this;
        }

        public HelmValidatorConfig build() {
            return new HelmValidatorConfig(helmValidatorUrl, version, enabled, deployable, lintable, strictLintable);
        }
    }
