...
public class SecurityManager {
    ...
    public boolean verifySignedData(final byte[] messageSyntaxSignature, final byte[] packageCert,
        ...
        try (ByteArrayInputStream signatureStream = new ByteArrayInputStream(messageSyntaxSignature);
            ...
            final Store certificates = signedData.getCertificates();
            final X509Certificate cert;
            if (packageCert == null) {
                final Collection<X509CertificateHolder> firstSignerCertificates = certificates
                ...
                final X509CertificateHolder firstSignerFirstCertificate = firstSignerCertificates.iterator().next();
