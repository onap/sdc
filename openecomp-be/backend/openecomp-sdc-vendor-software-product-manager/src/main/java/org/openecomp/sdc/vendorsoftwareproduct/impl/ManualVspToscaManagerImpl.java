...
public class ManualVspToscaManagerImpl implements ManualVspToscaManager {
    ...
    private final ManualVspDataCollectionService manualVspDataCollectionService = new ManualVspDataCollectionService();
    ...
    public VspModelInfo gatherVspInformation(String vspId, Version version) {
        ...
        try {
            vspComponentImages = manualVspDataCollectionService.getVspComponentImages(vspId, version);
        } catch (Exception ex) {
