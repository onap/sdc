...
public class CreatePackageForNonFinalVendorSoftwareProductErrorBuilder {
    ...
    private static final String CREATE_PACKAGE_FOR_NON_FINAL_VSP_MSG =
        "Package creation for vendor software product with id %s and version %s is not allowed since " + "it is not final (submitted).";
     ...
     */
    public CreatePackageForNonFinalVendorSoftwareProductErrorBuilder(String vendorSoftwareProductId, Version version) {
        builder.withId(CREATE_PACKAGE_FOR_NON_FINAL_VSP);
        builder.withCategory(ErrorCategory.APPLICATION);
        builder
            .withMessage(String.format(CREATE_PACKAGE_FOR_NON_FINAL_VSP_MSG, vendorSoftwareProductId, version == null ? null : version.toString()));
    }
