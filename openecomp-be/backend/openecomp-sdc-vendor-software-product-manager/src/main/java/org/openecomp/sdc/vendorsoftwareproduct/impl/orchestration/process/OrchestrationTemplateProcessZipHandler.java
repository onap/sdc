...
/**
 * The type Orchestration template process zip handler.
 */
public class OrchestrationTemplateProcessZipHandler implements OrchestrationTemplateProcessHandler {
  ...
  /**
   * Instantiates a new Orchestration template process zip handler.
   */
  public OrchestrationTemplateProcessZipHandler(){}

  /**
   * Process orchestration template candidate.
   *
   * @param vspDetails    the vsp details
   * @param candidateData the candidate data
   * @param user          the user
   * @return the orchestration template process action response
   */
