...
public class PackageInvalidErrorBuilder {
    ...
    private static final String PACKAGE_INVALID_MSG =
        "Package for vendor software product with Id %s and version %s is invalid " + "(does not contain translated data).";
    ...
    public PackageInvalidErrorBuilder(String vendorSoftwareProductId, Version version) {
        ...
        builder.withMessage(String.format(PACKAGE_INVALID_MSG, vendorSoftwareProductId, version == null ? null : version.toString()));
    }
