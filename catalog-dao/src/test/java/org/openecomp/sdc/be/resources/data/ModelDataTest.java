...
class ModelDataTest {
    ...
    private final String modelType = ModelTypeEnum.NORMATIVE.getValue();
    ModelData modelData;
    ...
    void modelDataTest() {
        ...
        assertThat(modelData.getModelType()).isEqualTo(modelType);
    }
    ...
    void modelDataFromPropertiesMapTest() {
        ...
        assertThat(modelDataFromPropertiesMap.getModelType()).isEqualTo(modelType);
    }
    ...
    void modelDataToGraphTest() {
        ...
        assertThat(result.values()).contains(modelType);
    }
