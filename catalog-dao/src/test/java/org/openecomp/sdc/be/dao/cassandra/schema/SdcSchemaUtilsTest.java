...
public class SdcSchemaUtilsTest {
	private static final String SINGLE_STATEMENT = "";
	private static final String[] MULTIPLE_STATEMENTS = new String[] {"",""};
	...
	private static Scassandra server = null;

	@BeforeClass
	public static void startServer() {
		server = CassandraTestHelper.getServer();
		server.start();
	}
