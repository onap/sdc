...
public class AdditionalInfoParameterData extends GraphNode {
    ...
    public AdditionalInfoParameterData(AdditionalInfoParameterDataDefinition additionalInfoParameterDataDefinition, Map<String, String> parameters,
    ...
    public AdditionalInfoParameterData(Map<String, Object> properties) {
        this();
        additionalInfoParameterDataDefinition.setUniqueId((String) properties.get(GraphPropertiesDictionary.UNIQUE_ID.getProperty()));
        additionalInfoParameterDataDefinition.setCreationTime((Long) properties.get(GraphPropertiesDictionary.CREATION_DATE.getProperty()));
        additionalInfoParameterDataDefinition.setModificationTime((Long) properties.get(GraphPropertiesDictionary.LAST_UPDATE_DATE.getProperty()));
        additionalInfoParameterDataDefinition
            .setLastCreatedCounter((Integer) properties.get(GraphPropertiesDictionary.PROPERTY_COUNTER.getProperty()));
        Type mapType = new TypeToken<HashMap<String, String>>() {
        }.getType();
        HashMap<String, String> prametersfromJson = getGson()
            .fromJson((String) properties.get(GraphPropertiesDictionary.ADDITIONAL_INFO_PARAMS.getProperty()), mapType);
        ...
        // .getProperty()));
        HashMap<String, String> idToKeyfromJson = getGson()
            .fromJson((String) properties.get(GraphPropertiesDictionary.ADDITIONAL_INFO_ID_TO_KEY.getProperty()), mapType);
    ...
    public Map<String, Object> toGraphMap() {
        ...
        addIfExists(map, GraphPropertiesDictionary.CREATION_DATE, additionalInfoParameterDataDefinition.getCreationTime());
        addIfExists(map, GraphPropertiesDictionary.LAST_UPDATE_DATE, additionalInfoParameterDataDefinition.getModificationTime());
        addIfExists(map, GraphPropertiesDictionary.PROPERTY_COUNTER, additionalInfoParameterDataDefinition.getLastCreatedCounter());
        return map;
    }
    ...
    public void setAdditionalInfoParameterDataDefinition(AdditionalInfoParameterDataDefinition additionalInfoParameterDataDefinition) {
        this.additionalInfoParameterDataDefinition = additionalInfoParameterDataDefinition;
    }
    ...
    public String toString() {
        return "PropertyData [parameters= " + parameters + " idToKey= " + idToKey + ", additionalInfoParameterDataDefinition="
            + additionalInfoParameterDataDefinition + "]";
    }
}
