...
public class RequirementData extends GraphNode {
    ...
    public String toString() {
        return "RequirementData [uniqueId=" + uniqueId + ", node=" + node + ", creationTime=" + creationTime + ", modificationTime="
            + modificationTime + ", relationshipType=" + relationshipType + ", minOccurrences=" + minOccurrences + ", maxOccurrences="
            + maxOccurrences + "]";
    }
}
