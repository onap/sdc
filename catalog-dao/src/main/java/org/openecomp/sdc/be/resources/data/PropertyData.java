...
public class PropertyData extends GraphNode {
    ...
    public PropertyData(Map<String, Object> properties) {
        ...
        propertyDataDefinition.setDescription((String) properties.get(GraphPropertiesDictionary.DESCRIPTION.getProperty()));
        Type listType = new TypeToken<List<String>>() {
        }.getType();
        List<String> constraintsfromJson = getGson().fromJson((String) properties.get(GraphPropertiesDictionary.CONSTRAINTS.getProperty()), listType);
        ...
        SchemaDefinition schema = getGson().fromJson((String) properties.get(GraphPropertiesDictionary.ENTRY_SCHEMA.getProperty()), schemaType);
