...
public class PropertyValueData extends GraphNode {
    ...
    public PropertyValueData(Map<String, Object> properties) {
        ...
        List<PropertyRule> propertyRules = getGson()
            .fromJson((String) properties.get(GraphPropertiesDictionary.PROPERTY_VALUE_RULES.getProperty()), mapType);
    ...
    public String toString() {
        return "PropertyValueData [uniqueId=" + uniqueId + ", value=" + value + ", type=" + type + ", creationTime=" + creationTime
            + ", modificationTime=" + modificationTime + ", rules=" + rules + "]";
    }
}
