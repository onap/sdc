...
public class GraphVertex {
    ...
    /**
     * Updates metadata json with current metadataProperties. Note that already existing property containing in metadata json can be overrided by new
     * value if metadataProperties contains the same property (by key). Note that metadata json can contain a property that is not presented in
     * metadataProperties. In such case the property will be put in metadata json.
     */
