...
public class JanusGraphDao {
    ...
    /**
     * Given a GraphVertex, returns the related GraphVertex with the highest version
     *
     * @param v the GraphVertex to get its highest related version
     * @return the related GraphVertex with the highest version
     */
    public GraphVertex getHighestVersionFrom(GraphVertex v) {
        Either<GraphVertex, JanusGraphOperationStatus> childVertexE =
        ...
        while (childVertexE.isLeft()) {
            ...
            childVertexE = getChildVertex(highestVersionVertex, EdgeLabelEnum.VERSION, JsonParseFlagEnum.NoParse);
        }
