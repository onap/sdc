...
public class RelationshipTypeData extends GraphNode {
    ...
    public RelationshipTypeData(Map<String, Object> properties) {
        this();
        relationshipTypeDataDefinition.setUniqueId((String) properties.get(GraphPropertiesDictionary.UNIQUE_ID.getProperty()));
        relationshipTypeDataDefinition.setType((String) properties.get(GraphPropertiesDictionary.TYPE.getProperty()));
        relationshipTypeDataDefinition.setDescription((String) properties.get(GraphPropertiesDictionary.DESCRIPTION.getProperty()));
        Type listSourceType = new TypeToken<List<String>>() {
        }.getType();
        List<String> validSourceTypesfromJson = getGson()
            .fromJson((String) properties.get(GraphPropertiesDictionary.VALID_SOURCE_TYPES.getProperty()), listSourceType);
        relationshipTypeDataDefinition.setValidSourceTypes(validSourceTypesfromJson);
        Type listTargetType = new TypeToken<List<String>>() {
        }.getType();
        List<String> validTargetTypesfromJson = getGson()
            .fromJson((String) properties.get(GraphPropertiesDictionary.VALID_TARGET_TYPES.getProperty()), listTargetType);
        ...
        // .getProperty()));
        relationshipTypeDataDefinition.setCreationTime((Long) properties.get(GraphPropertiesDictionary.CREATION_DATE.getProperty()));
        relationshipTypeDataDefinition.setModificationTime((Long) properties.get(GraphPropertiesDictionary.LAST_UPDATE_DATE.getProperty()));
    ...
    public Map<String, Object> toGraphMap() {
        ...
        addIfExists(map, GraphPropertiesDictionary.VALID_SOURCE_TYPES, relationshipTypeDataDefinition.getValidSourceTypes());
        addIfExists(map, GraphPropertiesDictionary.VALID_TARGET_TYPES, relationshipTypeDataDefinition.getValidTargetTypes());
        addIfExists(map, GraphPropertiesDictionary.CREATION_DATE, relationshipTypeDataDefinition.getCreationTime());
        addIfExists(map, GraphPropertiesDictionary.LAST_UPDATE_DATE, relationshipTypeDataDefinition.getModificationTime());
        return map;
    }
