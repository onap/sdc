...
public class CapabilityInstData extends GraphNode {
    ...
    public CapabilityInstData(Map<String, Object> properties) {
        ...
        List<String> propertiesfromJson = getGson().fromJson((String) properties.get(GraphPropertiesDictionary.PROPERTIES.getProperty()), listType);
    ...
    public String toString() {
        return "CapabilityInstData [uniqueId=" + uniqueId + ", properties=" + properties + ", creationTime=" + creationTime + ", modificationTime="
            + modificationTime + "]";
    }
}
