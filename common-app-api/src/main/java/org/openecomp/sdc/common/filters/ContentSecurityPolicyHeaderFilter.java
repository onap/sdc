...
public class ContentSecurityPolicyHeaderFilter implements Filter {
    ...
    private String permittedAncestors = null;

    @Override
    public void init(final FilterConfig filterConfig) throws ServletException {
        permittedAncestors = ConfigurationManager.getConfigurationManager().getConfiguration().getPermittedAncestors();
    }
