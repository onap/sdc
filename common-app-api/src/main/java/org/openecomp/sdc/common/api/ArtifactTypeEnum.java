...
public enum ArtifactTypeEnum {
    AAI_SERVICE_MODEL("AAI_SERVICE_MODEL"), AAI_VF_INSTANCE_MODEL("AAI_VF_INSTANCE_MODEL"), AAI_VF_MODEL("AAI_VF_MODEL"), AAI_VF_MODULE_MODEL(
        "AAI_VF_MODULE_MODEL"), ANSIBLE_PLAYBOOK("ANSIBLE_PLAYBOOK"), APPC_CONFIG("APPC_CONFIG"), BPEL("BPEL"), CHEF(
        "CHEF"), CLOUD_TECHNOLOGY_SPECIFIC_ARTIFACT("CLOUD_TECHNOLOGY_SPECIFIC_ARTIFACT"), CONTROLLER_BLUEPRINT_ARCHIVE(
        "CONTROLLER_BLUEPRINT_ARCHIVE"), DCAE_DOC("DCAE_DOC"), DCAE_EVENT("DCAE_EVENT"), DCAE_INVENTORY_BLUEPRINT(
        "DCAE_INVENTORY_BLUEPRINT"), DCAE_INVENTORY_DOC("DCAE_INVENTORY_DOC"), DCAE_INVENTORY_EVENT("DCAE_INVENTORY_EVENT"), DCAE_INVENTORY_JSON(
        "DCAE_INVENTORY_JSON"), DCAE_INVENTORY_POLICY("DCAE_INVENTORY_POLICY"), DCAE_INVENTORY_TOSCA("DCAE_INVENTORY_TOSCA"), DCAE_JSON(
        "DCAE_JSON"), DCAE_POLICY("DCAE_POLICY"), DCAE_TOSCA("DCAE_TOSCA"), DG_XML("DG_XML"), ETSI_PACKAGE("ETSI_PACKAGE"), GUIDE(
        "GUIDE"), HEAT_ARTIFACT("HEAT_ARTIFACT"), HEAT_ENV("HEAT_ENV"), HEAT("HEAT"), HEAT_NESTED("HEAT_NESTED"), HEAT_NET("HEAT_NET"), HEAT_VOL(
        "HEAT_VOL"), HELM("HELM"), ICON("ICON"), LIFECYCLE_OPERATIONS("LIFECYCLE_OPERATIONS"), MODEL_INVENTORY_PROFILE(
        "MODEL_INVENTORY_PROFILE"), MODEL_QUERY_SPEC("MODEL_QUERY_SPEC"), MURANO_PKG("MURANO_PKG"), NETWORK_CALL_FLOW(
        "NETWORK_CALL_FLOW"), ONBOARDED_PACKAGE("ONBOARDED_PACKAGE"), OTHER("OTHER"), PERFORMANCE_COUNTER("PERFORMANCE_COUNTER"), PLAN(
        "PLAN"), PM_DICTIONARY("PM_DICTIONARY"), PNF_SW_INFORMATION("PNF_SW_INFORMATION"), PUPPET("PUPPET"), SHELL_SCRIPT("SHELL_SCRIPT"), SHELL(
        "SHELL"), SNMP_POLL("SNMP_POLL"), SNMP_TRAP("SNMP_TRAP"), TOSCA_CSAR("TOSCA_CSAR"), TOSCA_TEMPLATE(
        "TOSCA_TEMPLATE"), UCPE_LAYER_2_CONFIGURATION("UCPE_LAYER_2_CONFIGURATION"), VENDOR_LICENSE("VENDOR_LICENSE"), VES_EVENTS(
        "VES_EVENTS"), VF_LICENSE("VF_LICENSE"), VF_MODULES_METADATA("VF_MODULES_METADATA"), VNF_CATALOG("VNF_CATALOG"), WORKFLOW(
        "WORKFLOW"), YANG_MODULE("YANG_MODULE"), YANG_XML("YANG_XML"), YANG("YANG");
