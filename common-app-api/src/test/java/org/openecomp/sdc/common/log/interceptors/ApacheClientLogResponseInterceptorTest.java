...
public class ApacheClientLogResponseInterceptorTest {
    ...
    public void testGetTargetServiceName() {
        ...
        assertEquals(testSubject.getTargetServiceName(httpRequest), "/testuri");
    }
    ...
    public void testGetServiceName() {
        ...
        assertEquals(testSubject.getServiceName(httpRequest), "/testuri/test");
    }
    ...
    public void testGetHttpStatusCode() {
        ...
        assertEquals(testSubject.getResponseCode(httpResponse), 200);
    }
