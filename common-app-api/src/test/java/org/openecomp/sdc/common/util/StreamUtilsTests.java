...
public class StreamUtilsTests {
    ...
    public <T> void testTakeErrorEvalOnlyOnce() {
        ...
        List<Either<Integer, Boolean>> collect = StreamUtils.takeWhilePlusOneNoEval(streamEithers, Either::isLeft).collect(Collectors.toList());
    ...
    public void testTakeWhilePlusOnePredicateIsMet() {
        List<Either<Integer, Boolean>> list = buildListWith10Integers();
        addToBooleansToList(list);
        final Stream<Either<Integer, Boolean>> takeWhilePlusOneStream = StreamUtils.takeWhilePlusOne(list.stream(), Either::isLeft);
