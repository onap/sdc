...
public class HttpClientConfigImmutableTest {
    ...
    public void validateArgConstructorCreatesValidImmutableConfig() {
        ...
        validateAllVildsInImmutableConfig(httpClientConfigImmutable);
    }
    ...
    private void validateAllVildsInImmutableConfig(HttpClientConfigImmutable httpClientConfigImmutable) {
        assertEquals(
