...
public class DeleteLastApplicationEnvironmentExceptionTest {
    ...
    public void validateOneArgConstructorsThrowsCorrectException() {
        ...
        try {
            ...
            assertEquals(re.getMessage(),testMessage);
    ...
    public void validateTwoArgConstructorsThrowsCorrectException() {
        ...
        try {
            throw new DeleteLastApplicationEnvironmentException(testMessage, new Throwable(testThrowableMessage));
        } catch (RuntimeException re) {
            assertEquals(re.getMessage(),testMessage);
            assertEquals(re.getCause().getMessage(),testThrowableMessage);
            throw new RuntimeException("");
        }
    }
